...
export default class Cells extends React.Component {
    static displayName = "Gridview-Cells";
    ...
    _canRender(canvasElement, tableElement, opeElement, headerElement){

        const paneElement = ReactDOM.findDOMNode(this.refs["gwpane"]);
    ...
    _operationRender(operationElement){
        const sheet = this.props.sheet;
        const opeModel = this.props.opeModel;
    ...
    _canvasRender() {
        ...
        const tableElement = this.state.tableElement;
        const opeElement = this.state.opeElement;
        const headerElement = this.state.headerElement;
