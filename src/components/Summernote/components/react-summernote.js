...
(function (factory) {
  ...
  var dom = (function () {
    ...
    var fromOffsetPath = function (ancestor, offsets) {
      ...
      if( offsets['length'] > 1 ) return ancestor.childNodes[0]; // 解决回撤 报错      
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.color', function () {
        ...
        context.memo('button.backColor', function () {
            return ui.buttonGroup({
                className: 'note-color',
                children: [
                    ui.button({
      ...
      var justifyLeft = ui.button({
        contents: ui.icon(options.icons.textLeft),
      ...
      context.memo('button.paragraph1', function () {
            return ui.buttonGroup([
                ui.button({
                    className: 'dropdown-toggle',
                    contents: ui.icon(options.icons.textLeft) + ' ' + ui.icon(options.icons.caret, 'span'),
                    tooltip: lang.paragraph.paragraph,
                    data: {
                        toggle: 'dropdown'
                    }
    ...
    this.updateCurrentStyle = function () {
      ...
      if (styleInfo['font-family']) {
        ...
        if(fontName =='system-ui' || !fontName){
            fontName = 'Arial'
        }
        ...
        $toolbar.find('.note-current-fontname').text(fontName);//fontName
      }
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
        ...
        'alignCenter': 'email-center',
        'alignJustify': 'email-lianbianduiqi',
        'alignLeft': 'email-zdq',
         'textLeft':'email-zuoduiqi',
        'alignRight': 'email-youduiqi',
        'indent': 'email-yduiq',
        'outdent': 'email-zdq',
        ...
        'table': 'email-biaoge',
        'textHeight': 'email-shangxiaduiqi',
        'trash': 'note-icon-trash',
        'underline': 'email-xiahuaxian',
        'undo': 'email-chexiao',
        'unorderedlist': 'email-biaoji',
...
var ReactSummernote = function (_Component) {
  ...
  function ReactSummernote(props) {
    ...
    _this.insertText = _this.insertText.bind(_this);
		_this.getText = _this.getText.bind(this);
    ...
    ReactSummernote.insertText = _this.insertText.bind(_this);
		ReactSummernote.getText = _this.getText.bind(_this);
    return _this;
  }
