    ...
    const Form = createReactClass({
      ...
      getFieldProps(name, usersFieldOption = {}) {
        ...
        if ('initialValue' in fieldOption) {
            if(fieldMeta.key !== fieldOption.key){
                fieldOption.refreshMark = true;
            } else if(fieldOption.initialValue && typeof fieldOption.initialValue === 'object'){
                if(fieldMeta.initialValue && typeof fieldMeta.initialValue === 'object'){
                    if('s_label' in fieldOption.initialValue){
                        fieldOption.refreshMark = fieldMeta.initialValue['s_label'] !== fieldOption.initialValue['s_label'];
                    }
                } else {
                    fieldOption.refreshMark = true;
                }
            } else {
                fieldOption.refreshMark = fieldMeta.initialValue !== fieldOption.initialValue;
            }
