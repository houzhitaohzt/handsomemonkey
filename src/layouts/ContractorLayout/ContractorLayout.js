...
import ProductHead from '../../routes/Contractor/Detail/Header/FWetailsHead';
import {apiGet, apiPost, apiForm, API_FOODING_ES, API_FOODING_DS } from "../../services/apiCall";

import DetailCommon from  '../../common/DetailCommon';
import Detail from  '../../routes/Contractor/Detail/Content/components/ServBeDetail';
import LinkMan from  '../../routes/Contractor/Linkman/components/Linkman';
import Email from  '../../routes/Contractor/Email/components/Email';
import Date  from  '../../routes/Contractor/Date/components/ServbeDate';
import Contact from  '../../routes/Contractor/Contact/components/ServbeContact';
import Accessory from  '../../routes/Contractor/Accessory/components/Accessory';
import Annotation from  '../../routes/Contractor/Annotation/components/Annotation';
export class ServbeLayout extends Component{
    ...
    getDetailData(obj){
        ...
        apiGet(API_FOODING_DS,"/carrier/getDetail",{id:this.state.id}, (response) => {
            let {carrierVo,regCapitalCurren,country}  = response.data; 
            this.setState({
                value:response.data,
                servBeVo:carrierVo,
                country:country,
