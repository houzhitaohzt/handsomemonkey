...
import FWDetailsHead from '../../routes/ForwarderContact/Detail/Header/FWDetailsHead';
import {apiGet, apiPost, apiForm, API_FOODING_ES, API_FOODING_DS } from "../../services/apiCall";
import ServiceTips from '../../components/ServiceTips';
import DetailCommon from  '../../common/DetailCommon';

import Detail from  '../../routes/ForwarderContact/Detail/Content/components/ProviderDetail';
import Email  from  '../../routes/ForwarderContact/Email/components/Email';
import Activity from  '../../routes/ForwarderContact/Activity/components/ForwarderContactActivity';
import Date from  '../../routes/ForwarderContact/Date/components/ForwarderContactDate';
import Contact from  '../../routes/ForwarderContact/Contact/components/ForwarderContactContact';
import Accessory from  '../../routes/ForwarderContact/Accessory/components/Accessory';
import Annotation  from  '../../routes/ForwarderContact/Annotation/components/Annotation';
...
export class SVCDetailLayout extends Component{
	constructor(props) {
		...
		this.state={
            ...
            curentId:DetailCommon.forwarderContact[this.props.location.query.id] || this.props.location.query.index  || 'detail'
    ...
    onClickLink(obj){
        ...
        DetailCommon.forwarderContact[this.props.location.query.id] = obj.id;
        that.setState({
            curentId:obj.id
        });
    }
