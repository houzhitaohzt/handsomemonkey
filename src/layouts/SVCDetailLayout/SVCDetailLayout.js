...
import FWDetailsHead from '../../routes/ServCon/Detail/Header/FWDetailsHead';
import {apiGet, apiPost, apiForm, API_FOODING_ES, API_FOODING_DS } from "../../services/apiCall";
import ServiceTips from '../../components/ServiceTips';

import DetailCommon from  '../../common/DetailCommon';

import Detail from  '../../routes/ServCon/Detail/Content/components/ProviderDetail';
import Email from  '../../routes/ServCon/Email/components/Email';
import Activity from  '../../routes/ServCon/Activity/components/ServConActivity';
import Date from  '../../routes/ServCon/Date/components/ServConDate';
import Contact from  '../../routes/ServCon/Contact/components/ServConContact';
import Accessory from  '../../routes/ServCon/Accessory/components/Accessory';
import Annotation  from  '../../routes/ServCon/Annotation/components/Annotation';
export class SVCDetailLayout extends Component{
	constructor(props) {
		...
		this.state={
			...
			detail:{},
            curentId:DetailCommon.severcon[this.props.location.query.id] || this.props.location.query.index  || 'detail'
    ...
    onClickLink(obj){
        ...
        DetailCommon.severcon[this.props.location.query.id] = obj.id;
        that.setState({
            curentId:obj.id
        });
    }
