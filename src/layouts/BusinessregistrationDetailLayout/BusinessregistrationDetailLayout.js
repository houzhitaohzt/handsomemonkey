...
import SODetailsHead from '../../routes/Businessregistration/Detail/Header/SODetailsHead';
...
import Detail from  '../../routes/Businessregistration/Detail/Content/components/BusinessregistrationDetail';
import Accessory from  '../../routes/Businessregistration/Accessory/components/Accessory';
import Confirm from "../../components/Dialog/Confirm";
export class BusinessregistrationDetailLayout extends Component{
    constructor(props) {
        super(props);
        this.state={
            paddingTop:115,
...
BusinessregistrationDetailLayout.propTypes = {
