...
import SODetailsHead from '../../routes/Vacationsingle/Detail/Header/SODetailsHead';
...
import Detail from  '../../routes/Vacationsingle/Detail/Content/components/VacationsingleDetail';
import Accessory from  '../../routes/Vacationsingle/Accessory/components/Accessory';
import Confirm from "../../components/Dialog/Confirm";
export class VacationsingleDetailLayout extends Component{
    constructor(props) {
        super(props);
        this.state={
            paddingTop:115,
...
VacationsingleDetailLayout.propTypes = {
