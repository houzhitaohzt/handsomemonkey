...
class LanguageMore extends Component{
	...
	render(){
		...
		let arrFil = arrLan.filter(e => e.id !== i18n.getLang());
		liDom = arrFil.map((e,i) => {
		...
		return(<div className={this.state.isFocuClass}
			...
			<div className={'lan-tip'} onMouseEnter={this.onFocus.bind(this)}>
