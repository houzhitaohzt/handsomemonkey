			 ...
			 dom = (<div className={'girdlayout'} style={{height:"170px"}}>
						...
						<div className={'row'}>
							<div className="form-group col-md-12">
								...
								<input type='text' className={'col-md-10 text-input-nowidth'}
									{...getFieldProps('url',{
										initialValue:''
									})} />
							</div>
						...
						<div className={'row'}>
							<div className="form-group col-md-12">
								<label className={'col-md-2'}><i>*</i>{i18n.t(200747/*所属系统*/)}</label>
			...
			dom = (<div className={'girdlayout'} style={{height:"170px"}}>
					<div className={'row'}>
						<div className="form-group col-md-12" style={{position:'relative'}}>
							...
							classn:'col-md-10 text-input-nowidth',initialValue:data.record.name}}/>
					...
					<div className={'row'}>
						<div className="form-group col-md-12">
							...
							classn:'col-md-10 text-input-nowidth',initialValue:data.record.identity}}/>
						</div>
					</div>
					<div className={'row'}>
						<div className="form-group col-md-12">
					...
					<div className={'row'}>
						<div className="form-group col-md-12">
							<label className={'col-md-2'}>{i18n.t(200747/*所属系统*/)}</label>
								<ConstMiniSelect form={this.props.form}
																						 pbj={{
																								 apiType: apiPost, host: API_FOODING_DS, uri:'/object/getList',
																								 params: {obj:'com.fooding.fc.enumeration.Module'}
																						 ...
																						 initValueOptions={[]}
																						 initialValue={
																							xt.initSelectValue(data.record.moduleId,{moduleId:data.record.module.id,name:data.record.module.name}, ['moduleId'], 'name', this.props.form)}
																						 optionValue={(da, di) => <Option key={di} objValue={{
																								 moduleId: da.id,
																								 name:da.name,
																								 s_label: da.name
