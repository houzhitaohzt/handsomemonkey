...
export class MeasureCommon extends Component{
	...
	render(){
		...
		if(this.props.data.length == 0){
			return (
			<RightKey array={arrayRightkey.filter(o=>o['permissions'] ? permissionsBtn(o['permissions']) : 1 )} handleClick={this.addClick.bind(this,{action:i18n.t(100392/*新增*/),name:{title:this.props.title},id:this.props.id,number:1})} isShowMenu={true} id={this.props.id} >
			...
			<div style={{width: '100%',borderRadius: '6px',zIndex:this.props.Zindex,position:"relative"}} className='menuset-measurement'>
				...
				<Morekeys iconArray= {iconArray.filter(o=>o['permissions'] ? permissionsBtn(o['permissions']) : 1 )} id={this.props.id} datat ={()=>this.refs["mainTable" + this.props.id].getSelectArr()} handleClick ={this.handleClick}/>
				<Table
