                ...
                <div className={'addnormal'} style={{marginBottom: '10px'}}>
                    <div className={'  girdlayout'}>
                        <div className={'row'}>
                            ...
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(200896/*属性*/)}</label>
                                <input type="text" {...getFieldProps('attribute', {
                                    initialValue: ''
                        ...
                        <div className={'row'}>
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(200897/*对象*/)}</label>
                            ...
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}>{i18n.t(200898/*类名*/)}</label>
                                <input type="text" {...getFieldProps('attrClass', {
                                    initialValue: ''
                                })} className={'col-md-8 col-lg-8 text-input-nowidth'}/>
                            </div>
                        </div>
                    ...
                    <div className={'  girdlayout'}>
                        <div className={'row'}>
                            ...
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(200896/*属性*/)}</label>
                                <input type="text" {...getFieldProps('attribute', {
                                    initialValue: checkedData.attribute
                                })} className={'col-md-8 col-lg-8 text-input-nowidth'}/>
                            </div>
                        </div>
                        <div className={'row'}>
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}>{i18n.t(200897/*对象*/)}</label>
                                ...
                                <ConstMiniSelect form={this.props.form}
                                        ...
                                        initValueOptions={[{objectId: checkedData.objectId, objectName: checkedData.objectName}]}
                                        reles={true}
                                        className ={'col-md-8 col-lg-8 currency-btn select-from-currency'}
                                        initialValue={xt.initSelectValue(checkedData,{objectId:checkedData.objectId,objectName:checkedData.objectName},['objectId'], 'objectName', this.props.form)}
                            ...
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}>{i18n.t(200898/*类名*/)}</label>
                                <input type="text" {...getFieldProps('attrClass', {
                                    initialValue: checkedData.attrClass
                                })} className={'col-md-8 col-lg-8 text-input-nowidth'}/>
                            </div>
                        </div>
                    </div>
            ...
            content = (
                <div className={'girdlayout scroll'} style={{overflow: 'auto'}}>
                    <div className={'row'}>
                        ...
                        <div className="form-group col-xs-6 col-md-6">
                            <label className={'col-xs-4 col-md-4'}>{i18n.t(200896/*属性*/)}</label>
                            <div className={'col-xs-8 col-md-8'}>
                                <p>{checkedData.record.attribute}</p>
                            </div>
                        </div>
                    </div>
                    <div className={'row'}>
                        <div className="form-group col-xs-6 col-md-6">
                            <label className={'col-xs-4 col-md-4'}>{i18n.t(200897/*对象*/)}</label>
                            <div className={'col-xs-8 col-md-8'}>
                                <p>{checkedData.record.objectName}</p>
                            </div>
                        </div>
                        <div className="form-group col-xs-6 col-md-6">
                            <label className={'col-xs-4 col-md-4'}>{i18n.t(200898/*类名*/)}</label>
                            <div className={'col-xs-8 col-md-8'}>
                                <p>{checkedData.record.attrClass}</p>
                            </div>
                        </div>
                    </div>
                </div>
