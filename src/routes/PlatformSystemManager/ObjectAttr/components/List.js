...
class PlatformSMObjectList extends Component {
    ...
    editClick(record) {
        var that = this;
        apiGet(API_FOODING_ES,'/objectAttributes/getOne',{id:record.record.id},(response)=>{
            that.setState({
                DialogContent:3,
                rodalShow : true,
                showHeader:true,
    ...
    deleteClick(data) {
        ...
        Confirm(tempString, {
                ...
                apiForm(API_FOODING_ES, '/objectAttributes/delete', {id: value}, (response) => {
                    that.getPage();
    ...
    onSaveAndClose(value, data, isAdd) {
        ...
        apiPost(API_FOODING_ES, '/objectAttributes/save', value, (response) => {
            that.setState({
                rodalShow: !!isAdd
            });
            successTips(response.message);
    ...
    getPage(currentPage,objValue){
        ...
        apiGet(API_FOODING_ES, '/objectAttributes/getPage',object,
                (response)=>{   
                    that.setState({ 
