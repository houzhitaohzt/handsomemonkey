		...
		if(this.state.showFilter==='comb-panel'){
			domFilter=(
				<div className={'filter-header'}>
                    ...
                    <div className={'filter-header-information-pre'}>
                        <label>{i18n.t(200747/*所属系统*/)}</label>
                        <ConstMiniSelect form={this.props.form} reles={true} pbj='com.fooding.fc.enumeration.Module' fieldName="moduleId"
                                         initialValue='' className = 'currency-btn select-from-currency' style={{width: 200}}/>
                    </div>
