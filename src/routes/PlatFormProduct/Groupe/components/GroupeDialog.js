...
export class GroupeDialog extends Component{
	...
	onSaveAndClose(){
		if(!this.state.checkedKeys.length){
			ServiceTips({text:i18n.t(200871/*请选择产品分组*/),type:"info"});
			return;
		}
		apiForm(API_FOODING_DS,'/platformMaterial/saveDataMulDiv2s',{id:this.props.id,dataMulDiv2id:this.state.checkedKeys},response => {
