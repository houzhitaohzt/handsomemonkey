...
export class Chenpsort extends Component{
    ...
    deleteNode = (ids) => {
        if(!ids.length) {
            ...
            Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
                    ...
                    apiForm(API_FOODING_DS,'/platformMaterial/deleteDataMulDiv1s',{id:this.state.id,dataMulDiv1ids:ids}, response => {
    ...
    getInitData = () => {
        ...
        apiGet(API_FOODING_DS,'/platformMaterial/getOne',{id:this.state.id},response => {
            ...
            ServiceTips({text:i18n.t(201286/*请刷新后再试*/),type:"error"})
        })
    }
    componentDidMount(){
