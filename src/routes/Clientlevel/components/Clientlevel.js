...
import ClientlevelPlug from './ClientlevelPlug';
...
class Clientlevel extends Component{
	constructor(props){
		super(props);
				...
				<div className={'client-body-single'}>
				  <div className="action-buttons">
					...
					<Dialog width={926} visible={this.state.rodalShow} title={this.state.title} showHeader ={this.state.showHeader}>
						<ClientlevelPlug DialogContent={this.state.DialogContent}
...
export default NavConnect(Clientlevel);
