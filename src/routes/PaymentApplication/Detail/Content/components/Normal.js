...
import {permissionsBtn, apiGet, apiPost, apiForm, API_FOODING_ES,sourceRouter,API_FOODING_ERP,API_FOODING_DS,pageSize,sizeList,language,toDecimal} from "../../../../../services/apiCall";
				...
				<div className={'businessdetailnormal-content girdlayout'}>
					...
					<div className={'row'}>
						...
						<div className="form-group col-md-3 col-lg-3">
							...
							<div className={'col-md-8 col-lg-8'}>
								{(getOne.sourceType==500 || getOne.sourceType == 338 || getOne.sourceType == 449)?<a className={'paragraph shengyue link-color'} onClick={this.linkClick}>{getOne.sourceNo}</a>:<p className="paragraph shengyue">{getOne.sourceNo}</p>}
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(200841/*申请付款金额*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{toDecimal(getOne.orderAmt)}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(200817/*申请人*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["payStaff"+language]}</p>
							</div>
						</div>
					</div>
					<div className={'row'}>
						<div className="form-group col-md-3 col-lg-3">
							...
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["receiptBe"+language]}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(100133/*支付条款*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["payTrm"+language]}</p>
							</div>
						</div>
                        <div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(500063/*付款方式*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["payTrmTy"+language]}</p>
							</div>
						</div>
					</div>
                    <div className={'row'}>
						<div className="form-group col-md-3 col-lg-3">
							...
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["payCc"+language]}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(200856/*收款人姓名*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne.receiverName}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>{i18n.t(500086/*收款账号*/)}</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne.receBankAccount}</p>
							</div>
						</div>
                        <div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-4 col-lg-4'}>SWIFTCODE</label>
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne.swiftCode}</p>
							</div>
						</div>
					</div>
                    <div className={'row'}>
						<div className="form-group col-md-3 col-lg-3">
							...
							<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["receBank"+language]}</p>
							</div>
						</div>
                        <div className="form-group col-md-3 col-lg-3">
                            <label className={'col-md-4 col-lg-4'}>{i18n.t(200822/*银行英文地址*/)}</label>
                        	<div className={'col-md-8 col-lg-8'}>
								<p className={'paragraph shengyue'}>{getOne["bankEnAddr"]}</p>
							</div>
                        </div>
