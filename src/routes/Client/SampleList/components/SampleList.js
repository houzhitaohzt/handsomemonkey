...
class SampleList extends Component{
    constructor(props){
        super(props);
        props.sampleList && props.sampleList(this);
        this.columns = [{
    ...
    onRowDoubleClick(record,index,checked){
        ...
        let name = i18n.t(200171/*销售样品单*/);
        navAddTab({name: name, component: name, url: '/samporder/detail'});
    ...
    addClick = () =>{
        ...
        if(irowSts==10){
            ...
            navAddTab({ name: i18n.t(200183/*新增销售样品单*/), component: i18n.t(200183/*新增销售样品单*/), url: '/samporder/edit/add'});
            this.props.router.push({pathname: '/samporder/edit/add', query: {cid: this.props.customer.id}});
        }else{
            errorTips('请先激活此客户!');
        }
    };
