...
import {I18n} from '../../../../lib/i18n';
import RepeatSchedule from "../../../Schedule/components/RepeatSchedule"; //重复点击后出来的弹层
import {getExplain} from "../../../Schedule/components/util";
...
export class CreateScheduleDialog extends Component {
    ...
    onSaveAndClose() {
        let that = this;
        const {form, onSaveAndClose, activityDtos} = this.props;
        form.validateFields((errors, value) => {
            if (errors) {
                ...
                param = Object.assign({}, param, {
                    ...
                    businessDate: new Date(this.props.starts).Format("yyyy-MM-dd 00:00:00"),
                ...
                <FormWrapper showFooter={true} onSaveAndClose={this.onSaveAndClose} onCancel={this.onCancel}
                    ...
                    <div className={'  girdlayout scroll'} style={{height: '300px', overflow: 'auto'}}>
                        <div className={'row'}>
                            ...
                            <div className="form-group col-md-6 col-lg-6">
                                <label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(500303/*日程类型*/)}</label>
                                <ConstVirtualSelect
                                    isRequest={false}
                                    form={this.props.form}
                                    fieldName='activityType'
                                    initialValue={String(valueone.activityType || "")}
                                    initValueOptions={[
