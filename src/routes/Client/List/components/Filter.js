...
import ProductSelect, {ProductName,CustomerFilter} from "../../../../components/FindGridSelect";
...
class ForwarderFilterHeader extends Component{
    ...
    render(){
        ...
        return(
            <div className={'search'} style={{border:'0px', borderRadius:'0px'}}>
                <label style={{width: '70px',position: 'absolute',top: '4px',left: '0', display: 'inline-block', padding:'0', margin:'0'}}>{i18n.t(500349/*客户筛选*/)}</label>
                <CustomerFilter
                    ref ="productSelect"
                    form={this.props.form}
                    width={'379%'}
                    fieldName ='customerFiltrateId'
