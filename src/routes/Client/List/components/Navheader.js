        ...
        if (this.state.showFilter === 'comb-panel') {
            domFilter = (
                <div className={'filter-header'}>
                    ...
                    <div className={this.state.minor}>
                        <label>{i18n.t(100360/*客户类型*/)}</label>
                        <ConstVirtualSelect
                            form={form}
                            style={{width: 200}}
                            apiType={apiPost}
                            fieldName="cstmTypeId"
                            apiParams="com.fooding.fc.ds.entity.CstmType"
                            valueKeys={ da => ({
                                cstmTypeId: da.id,
                                cstmTypeLocalName: da.localName,
                                s_label:da.localName
                            })}
                        />
                    </div>
                    ...
                    <div className={this.state.minor}>
                        ...
                        <ConstVirtualSelect
                            ...
                            isRequest={false}
                            initValueOptions={[
                                {name: i18n.t(200452/*所有的*/), value: ''},{name: i18n.t(201279/*已下单*/), value: true},{name: i18n.t(201280/*未下单*/), value: false}
                                ]}
                            valueKeys={ da => ({
                                tradMark: da.value,
                    ...
                    <div className={this.state.minor}>
                        <label className="current-data-label">{i18n.t(500333/*客户建立日期*/)}</label>
                        <DataTime
                            showTime={false}
                            name="startTime"
                            width={200}
                    ...
                    <div className={this.state.minor}>
                        <label className='current-data-label'>{I18n.t(300015/*首选联系方式*/)}</label>
                    ...
                    <div className={this.state.minor}>
                        ...
                        <input type="text" className="text-input-filter-header" name="web"
                               {...getFieldProps('web', {initialValue: ''})}
                               onKeyDown={(e)=>{
                                   if(e.keyCode == 13){this.props.searchCustomer();}
                               }}
                        />
