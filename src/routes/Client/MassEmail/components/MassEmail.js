...
export class Clentlist extends Component{
    ...
    forwardClick = ()=> {
		let that = this;
        let list = this.refs.product.getSelectArr();
        ...
        let row = list[0];
        window.navTabs.open(i18n.t(700006/*写邮件*/),`/email/write`,{type:'masscopy',collectionName:row['email'],mailId:row['id']},{refresh: true});        
    }
        ...
        return (
            <div className="contact-fluid">
                ...
                <div className="contact-body" style = {{height:this.state.scrollHeight}}>
                    <FunctionKeys forwardClick={this.forwardClick}/>
                    <Page
