...
export class TransportRequire extends Component{
	...
	render(){
		...
		return (
					<FormWrapper showFooter={true} buttonLeft = {this.props.buttonLeft} onSaveAdd={this.onSaveAdd} showSaveAdd={!data.number == 0} onSaveAndClose={this.onSaveAndClose} onCancel={this.onCancel}>
						{content}
					</FormWrapper>
		)
	}
