					...
					<div className={'  girdlayout'}>
						...
						<div className={'row'}>
								<div className="form-group col-md-12 col-lg-12">
									<label className={'col-md-1 col-lg-1'}>{i18n.t(100002/*描述*/)}</label>
			   	...
			   	<div className={'addnormal'} style={{marginBottom:'10px'}}>
					<div className={'  girdlayout'}>
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-2 col-lg-2'}><span>*</span>ID</label>
								<input type="text" {...getFieldProps('id', {
						             initialValue:checkedData.id
						        })} className={'col-md-10 col-lg-10 text-input-nowidth'} readOnly/>
							</div>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-2 col-lg-2'}><span>*</span>{i18n.t(100000/*代码*/)}</label>
								<Input form={this.props.form} obj={{name:'code',type:'text',
			...
			content = (
				<div className={'girdlayout scroll'} style={{overflow:'auto'}}>
					...
					<div className="form-group col-xs-6 col-md-6">
							<label className={'col-xs-4 col-md-4'}>id</label>
