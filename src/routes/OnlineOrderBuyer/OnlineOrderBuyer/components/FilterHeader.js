...
class SendQuotationFilterHeader extends Component {
    ...
    render() {
        let domFilter;
        let array = [{id: 0, content: I18n.t(500018/*全部订单*/)}, {
            id: 1,
            content: I18n.t(300039/*草稿*/)
        }, {permissions: 'onlineorderbuyer.done', id: 30, content: I18n.t(100457/*下单*/)}, {
            id: 35,
            content: I18n.t(500021/*卖方确认*/)
        }, {id: 25, content: I18n.t(100432/*关闭*/)}];
            ...
            domFilter = (
                <div className={'filter-header'}>
                    ...
                    <div className={'filter-header-key'}>
                        <span className="search" onClick={this.props.searchCustomer}><i
