...
export default class NormlEdit extends Component {
    ...
    componentDidMount(){
        apiPost(API_FOODING_DS,'/object/getMiniList',{obj:'com.fooding.fc.es.entity.Party',
            queryParams:[{attr:"id",expression:"<>", value: WebData.user.data.staff.ccid},{attr:"typeId",expression:"=", value:30}]},
            (response)=>{
                this.setState({
            ...
            <div className={'  girdlayout'}>
                ...
                <div className={'row'}>
                     <div className="form-group col-md-6 col-lg-6">
                            <label className={'col-md-2 col-lg-2'}>{I18n.t(500084/*关闭原因*/)}</label>
