/*
	create by houzhitao
	查看审批 公共的流程 (应该仅仅用于erp)
*/
import React, {Component, PropTypes} from "react";
import {createForm,FormWrapper} from "../../../../../components/Form";
// ajax
import {apiGet,apiPost,apiForm,API_FOODING_ERP,API_FOODING_DS,API_FOODING_ES} from '../../../../../services/apiCall';
...
class ApprovalDialog extends Component{
	...
	initApprovalList = (billId,billType) => {
		if(!billId) return;
		if(!billType) return;
		apiGet(API_FOODING_ERP,'/common/getApprovalRecords',{billType:billType,billId:billId},response => {
