...
export class CostlvtPlug extends Component{
	constructor(props){
		super(props);
		this.addSelect;
					...
					<div className={'  girdlayout'}>
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(100003/*ID*/)}</label>
				...
				<div className={'girdlayout scroll'} style={{overflow:'auto'}}>
					<div className={'row'}>
						<div className="form-group col-xs-6 col-md-6">
							<label className={'col-md-4 col-lg-4'}>{I18n.t(100003/*ID*/)}</label>
...
const ProductForm =createForm()(CostlvtPlug); 
