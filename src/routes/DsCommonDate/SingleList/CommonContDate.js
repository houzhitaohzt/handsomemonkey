...
class CommonContDate extends Component{
	...
	addClick = () => {
		let that = this,title;
		let {navAddTab, navRemoveTab,activityType,navReplaceTab} = that.props;  
	     navRemoveTab({name:I18n.t(100439/*编辑*/) + I18n.t(100587/*约会*/),component:I18n.t(100439/*编辑*/) + I18n.t(100587/*约会*/),url:'/commondate/edit'});
	     navAddTab({ name: I18n.t(100392/*新增*/) + I18n.t(100587/*约会*/), component: I18n.t(100392/*新增*/) + I18n.t(100587/*约会*/), url: '/commondate/edit'});
	     that.props.router.push({pathname:'/commondate/edit',query:{salBeId:this.props.salBeId,originalId:this.props.originalId,originalType:this.props.originalType,activityType:this.props.activityType,salBeLC:encodeURIComponent(this.props.salBeLcName),salBeEN:encodeURIComponent(this.props.salBeEnName),typeNumber:this.props.typeNumber,isDt:this.props.isDt}});
    }
    onRowDoubleClick = (record,index,checked) => {
		let {navRemoveTab,navAddTab,activityType} =this.props;
		navRemoveTab({name:I18n.t(100587/*约会*/) + I18n.t(100097/*详情*/),component:I18n.t(100587/*约会*/) + I18n.t(100097/*详情*/),url:'/commondate/detail'});
	    navAddTab({ name:I18n.t(100587/*约会*/) + I18n.t(100097/*详情*/), component: I18n.t(100587/*约会*/) + I18n.t(100097/*详情*/), url: '/commondate/detail'});
        this.props.router.push({pathname: '/commondate/detail', query: {scheduleId: record.id,salBeId:this.props.salBeId,originalId:this.props.originalId,originalType:this.props.originalType,activityType:this.props.activityType,salBeLC:encodeURIComponent(this.props.salBeLcName),salBeEN:encodeURIComponent(this.props.salBeEnName),typeNumber:this.props.typeNumber,isDt:this.props.isDt}});
	}
	//删除数据
    deleteClick = () => {
    	let that = this;
    	let num = that.refs['commondate'+ this.props.type + this.props.activityType].getSelectArr();
    	let tempString = "", id = [];
    	if(!num.length){
	...
	componentWillUnmount() {
  	...
  	componentWillReceiveProps(nextProps){
  		this.handleResize(0);
		window.addEventListener('resize', this.handleResize(0));
		if(this.props.activityType !== nextProps.activityType || this.props.salBeId !== nextProps.salBeId || this.props.typeNumber !== nextProps.typeNumber){
			...
			<div className="contact-fluid">
				...
				<div className="contact-body" style = {{height:this.state.scrollHeight}}>
					...
					<div className="action-contact-buttons">
						<Table
							ref={'commondate'+ this.props.type + this.props.activityType}
