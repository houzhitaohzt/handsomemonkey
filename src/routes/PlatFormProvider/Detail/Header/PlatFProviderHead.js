...
export  class  PlatFProviderHead extends Component{
	    constructor(props) {
	        super(props);
	        this.array =[];
					let navTabs=[
						{name:i18n.t(200582/*供应商产品*/),url:'/platform/provider/detail',id:0},
						{name:i18n.t(100139/*注册信息*/),url:'/platform/provider/info',id:1}
			];
...
export default LocationConnect(withRouter(PlatFProviderHead));
