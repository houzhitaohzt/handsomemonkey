					...
					<div className="common-party">
						<div className="row">
							<div className={'col-xs-4'}>
								<label className="party-label">{i18n.t(200467/*供应商名称*/)}</label>
								<input type="text" placeholder="" className="text-input" {...getFieldProps('Code',{
											validateFirst: true,
											rules: [{required:true,}],
							...
							<div className={'col-xs-3'}>
								<label className="party-label">{i18n.t(200468/*供应商等级*/)}</label>
								<Select
									animation='slide-up'
									placeholder=''
									style={{width:120}}
