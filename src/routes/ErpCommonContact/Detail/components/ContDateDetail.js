...
export  class  contDateDetail extends Component{
	...
	editClick = () => {
		...
		navReplaceTab({name:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),component:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),url:'/ccontacterp/edit'});
		that.props.router.push({pathname:'/ccontacterp/edit',query:oldQuery, state: {refresh: true}});
	}
	backClick = () => {
		let that = this;
		let {navAddTab,navReplaceTab} = that.props;
		let oldQuery = this.props.location.query;
		navReplaceTab({name:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),component:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),url:'/ccontacterp/edit'});
		that.props.router.push({pathname:'/ccontacterp/edit',query:oldQuery, state: {refresh: false}});
	}
