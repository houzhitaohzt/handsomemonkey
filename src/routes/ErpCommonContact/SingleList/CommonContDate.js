...
class CommonContDate extends Component{
	constructor(props){
		...
		this.iconArray =  [{type:'add',onClick:this.addClick},{type:'delete',onClick:this.deleteClick}];
		this.state = {
			scroll:0,
			paddingTop:0,
			checkedRows:[],
	...
	addClick = () => {
		...
		let {navAddTab, navRemoveTab,activityType} = that.props; 
	     navRemoveTab({name:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),component:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),url:'/ccontacterp/edit'});
	     navAddTab({ name:I18n.t(100392/*新增*/) + I18n.t(100588/*联络*/), component: I18n.t(100392/*新增*/) + I18n.t(100588/*联络*/), url: '/ccontacterp/edit'});
	     that.props.router.push({pathname:'/ccontacterp/edit',query:{salBeId:this.props.salBeId,originalId:this.props.originalId,originalType:this.props.originalType,activityType:this.props.activityType,salBeLC:encodeURIComponent(this.props.salBeLcName),salBeEN:encodeURIComponent(this.props.salBeEnName),typeNumber:this.props.typeNumber,isDt:this.props.isDt}});
    }
    onRowDoubleClick = (record,index,checked) => {
		let {navRemoveTab,navAddTab,activityType} =this.props;
		navRemoveTab({name:I18n.t(100588/*联络*/) + I18n.t(100097/*详情*/),component:I18n.t(100588/*联络*/) + I18n.t(100097/*详情*/),url:'/ccontacterp/detail'});
	    navAddTab({ name:I18n.t(100588/*联络*/) + I18n.t(100097/*详情*/), component: I18n.t(100588/*联络*/) + I18n.t(100097/*详情*/), url: '/ccontacterp/detail'});
        this.props.router.push({pathname: '/ccontacterp/detail', query: {scheduleId:record.id,salBeId:this.props.salBeId,originalId:this.props.originalId,originalType:this.props.originalType,activityType:this.props.activityType,salBeLC:encodeURIComponent(this.props.salBeLcName),salBeEN:encodeURIComponent(this.props.salBeEnName),typeNumber:this.props.typeNumber,isDt:this.props.isDt}});
	}
	//删除数据
    deleteClick = () => {
    	let that = this;
		...
		return (
			<div className="contact-fluid">
				...
				<div className="contact-body" style = {{height:this.state.scrollHeight}}>
					<Confirm iconArray ={this.iconArray}/>
					<Page 
