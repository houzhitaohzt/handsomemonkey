...
class ServConActivity extends Component{
	constructor(props){
		super(props)
	...
	*/
	render(){
		...
		return(<CommonActivity pageIdent='serverLinkman' type={"servconactivity"} activityType={30}
							   activity ={no => this.activity = no}  isDetail ={true}
							   router={this.props.router} salBeId={salBeId} salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={110}/>)
	}
}
export default ServConActivity;