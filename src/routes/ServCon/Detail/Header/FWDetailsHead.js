...
export  class  FWDetailsHead extends Component{
	    constructor(props) {
	        ...
	        this.array =[];
					let navTabs=[
						{name:i18n.t(100097/*详情*/),url:'/servcon/detail',id:'detail',isLoading:false},
						{name:i18n.t(100586/*邮件*/),url:'/servcon/email',id:'email',isLoading:false},
						{name:i18n.t(100585/*市场活动响应*/),url:'/servcon/activity',id:'activity',isLoading:false},
						{name:i18n.t(100587/*约会*/),url:'/servcon/date',id:'date',isLoading:false},
						{name:i18n.t(100588/*联络*/),url:'/servcon/contact',id:'contact',isLoading:false},
						// {name:'历史记录',url:'/servcon/history',id:5},
						{name:i18n.t(100136/*附件*/),url:'/servcon/accessory',id:'accessory',isLoading:false},
						{name:i18n.t(100148/*注释*/),url:'/servcon/annotation',id:'annotation',isLoading:false}
			];
						...
						<div className="box5">
								<div className="top">
										<div className="box6">
												...
												<div className="gery">
													<div className="flex"><div className="nation"><span>{i18n.t(100313/*服务机构*/)}</span><b>{value.enterprise?value.enterprise.localName:''}</b></div></div>
