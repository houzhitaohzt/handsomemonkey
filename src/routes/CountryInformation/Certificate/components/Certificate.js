...
export class Certificate extends Component{
	constructor(props){
		super(props);
        props.certificate && props.certificate(this);
		this.state = {
			scrollHeight:0,
            visible:false,
            dialogTitle:'',
    ...
    getPage(sID,objValue){
        ...
        if(objValue){
            ...
            // body... 
                ...
                apiGet(API_FOODING_DS,'/tradruleCertfct/getList',object,
                    (response)=>{   
                        that.setState({ 
                            data: response.data,
    ...
    addClick(){
    	  	let dialogTitle=I18n.t(100099/*证书新增*/);
        	 this.setState({
        	 	visible:true,
    ...
    deleteClick(data,e){
        ...
        if(data&&data.id){
            ...
            Confirm(I18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
                            ...
                            apiForm(API_FOODING_DS,'/tradruleCertfct/delete',{id:value},(response)=>{
                                that.getPage();
                                ServiceTips({text:response.message,type:'success'});
                                that.setState({
                                    selectArray:[]
