		...
		if(this.state.showFilter==='comb-panel'){
			domFilter=(
				<div className={'filter-header'}>
					...
					<div className={this.state.minor}>
						<label>{I18n.t(500328/*完成状态*/)}</label>
						<Select
								{...getNFieldProps('finishStatus',{
									initialValue:undefined								
								})} 
								animation='slide-up'
								placeholder=''
							...
							>
								<Option key={0} value={''} title={I18n.t(400051/*不限*/)}>{I18n.t(400051/*不限*/)}</Option>					
								<Option key={1} value={'20'} title={I18n.t(200283/*已完成*/)}>{I18n.t(200283/*已完成*/)}</Option>
								<Option key={2} value={'10'} title={I18n.t(600188/*未完成*/)}>{I18n.t(600188/*未完成*/)}</Option>
							</Select>
					</div>
