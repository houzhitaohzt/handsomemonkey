...
class StockIn extends Component{
	...
	addClick(){
		...
		navAddTab({id:7,name:I18n.t(500132/*入库通知单新增*/),component:I18n.t(500132/*入库通知单新增*/),url:'/stockin/add'});
		this.props.router.push('/stockin/add');
	}
	// 删除
	...
	onRowDoubleClick(record,index,checked){
		let {navAddTab} =this.props;
		navAddTab({id:9,name:I18n.t(500133/*入库通知单详情*/),component:I18n.t(500133/*入库通知单详情*/),url:'/stockin/detail'});
		this.props.router.push({ pathname: '/stockin/detail',query:{id:record.billId}});
	}
	...
	getPage(currentPage,objValue){
		...
		let object=Object.assign({},{isPlatform:true, billType:222, pageSize: this.state.pageSize, currentPage: currentP},that.normalRef.getForm());
