	               ...
	               <div style={{backgroundColor:'#f0f4f8',marginTop:'10px'}}>
		               <div>
		                    <Measurement 
								...
								onCancel ={this.onCancel} title = {I18n.t(500159/*入库明细*/)} openDialog={this.handleClick}
								...
								iconArray={[0,1,2]}
			                     columns ={
			                    	[{
										...
										width : "10%",
										render(data,row,index){
											return (<div>{data?(toDecimal(data)+' '+row.purCnyLcName):''}</div>)
										}
									},{
