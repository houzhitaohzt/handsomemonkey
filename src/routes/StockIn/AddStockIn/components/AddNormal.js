...
class Addnormal extends Component{
	...
	shiwuClick(){
		var that = this;
		apiPost(API_FOODING_DS,'/object/getMiniList',{obj:'com.fooding.fc.ds.entity.StorOpert',queryParams:[{attr:'stOpeID',expression:'=',value:'10'}]},
		(response)=>{
				that.setState({
	...
	onSelect(slId,item){
		...
		if(item.props.objValue && item.props.objValue.slId){
		...
		return(
			<div className={'addnormal'}>
				...
				<div className={'  girdlayout'}>
					...
					<div className={'row'}>
						<div className="form-group col-md-4 col-lg-4">
							...
							<ConstMiniSelect form={this.props.form}
                                                 ...
                                                 initValueOptions={[]}
                                                 initialValue={
                                                    xt.initSelectValue(getOne["sl"+language], getOne, ['slId', 'slLcName', 'slEnName'], "sl"+language, this.props.form)
                                                 }
					...
					<div className={'row'}>
						<div className="form-group col-md-4 col-lg-4">
							<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(500137/*预计入库日期*/)}</label>
							<div className={'col-md-8 col-lg-8 datetime'}>
								<DataTime 
									showTime={false}
									isShowIcon={true}
						...
						<div className="form-group col-md-4 col-lg-4">
							...
							>	
										                {this.state.shiwuArray.map((o,i)=><Option key={i} objValue={{s_label:o.localName, stOpeId: o.id, stOpeLcName :o.localName, stOpeEnName: o.name}} title={o.localName}>{o.name}</Option>)}
							</Select>
						</div>
						<div className="form-group col-md-4 col-lg-4">
