		...
		return(<div className={'addnormal'} style={{marginBottom:'10px'}}>		
					...
					<div className={'  girdlayout'}>
						...
						<div className={'row'}>
							...
							<div className="form-group col-md-3 col-lg-3">
								<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(500047/*收货电话*/)}</label>
								<div className={'col-md-8 col-lg-8'}>
						...
						<div className={'row'}>
							<div className="form-group col-md-3 col-lg-3">
								<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(500049/*收货地址*/)}</label>
								<div className={'col-md-8 col-lg-8'}>
						...
						<div className={'row'}>
							...
							<div className="form-group col-md-3 col-lg-3">
								...
								<div className={'col-md-8 col-lg-8'}>
									<p className={'paragraph'}>{businessOne.noticeAdd}</p>
								</div>
							</div>
						</div>
					</div>
