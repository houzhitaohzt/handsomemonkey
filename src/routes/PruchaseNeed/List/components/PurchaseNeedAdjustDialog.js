...
class PurchaseNeedAdjustDialog extends Component {
    ...
    LinkClick = (billType, billId, no) => {
        ...
        if(billType == 338){ //searchField=no=PC1711150004
    ...
    render() {
            ...
            tipDom = (<div className={'row'}>
                <div className="form-group col-md-9 col-lg-9">
                    ...
                    <div className={'col-md-11 col-lg-11'}>
                        <p className={'paragraph'}>{I18n.t(400043/*请点击下面*/)}<span style={{
                            fontWeight: "bold",
                            color: "blue"
                        }}>&nbsp;&nbsp;{I18n.t(400044/*进入页面*/)}&nbsp;&nbsp;</span>{I18n.t(400045/*链接,进入页面进行数据调整,再返回页面进行*/)}{I18n.t(400046/*刷新*/)}
                        </p>
                    </div>
                </div>
                <div className="form-group col-md-1 col-lg-1">
                    <label onClick={this.onFreshClick} style={{cursor: "pointer"}}><i
                        className={"foddingicon fooding-update"}
                        title={I18n.t(400046/*刷新*/)}></i>&nbsp;&nbsp;{I18n.t(400046/*刷新*/)}&nbsp;&nbsp;</label>
                </div>
            </div>)
        }
        let singleDom = this.state.valueone.map((e, i) => {
            return (<div key={i} className={'row'}>
                ...
                <div className="form-group col-md-3 col-lg-3">
                    <label><a href="javascript:;" onClick={this.LinkClick.bind(this, e.billType, e.billId, e.no)}
                              className={'link-route'}>{i18n.t(400044/*进入页面*/)}</a></label>
                </div>
            </div>)
        })
        return (<FormWrapper showFooter={true} onSaveAndClose={this.onSaveAndClose} onCancel={this.onCancel}
                             onSaveCloseBoolean={isonSaveCloseBoolean}>
                ...
                <div className={'row'}>
                    ...
                    <div className="form-group col-md-6 col-lg-6">
                        ...
                        >
                            ...
                            {
                                dataArr.map((e, i) => {
                                    return <Option key={e.billId} objValue={{
                                        id: String(e.billId),
                                        orderTypeName: e.orderTypeName,
                                        s_label: e.no
                                    }} title={e.no}>{e.no}</Option>
                                })
                            }
                        </Select>
                    </div>
