		...
		if(this.state.showFilter==='comb-panel'){
			domFilter=(
				<div className={'filter-header'}>
					...
					<div className={'filter-header-information-pre'}>
						<label>{i18n.t(500299/*推送日期*/)}</label>
						<DataTime 
							width={200}  
							showTime = {false} 
							isShowIcon={true} 
					...
					<div className={'filter-header-information-pre'}>
						<label>{i18n.t(500300/*推送状态*/)}</label>
						<Select
						...
						>
							<Option key={0} value={i18n.t(NaN/**/)} title={'全部'}>{i18n.t(500301/*全部*/)}</Option>							
							<Option key={0} value={'1'} title={i18n.t(201065/*已确认*/)}>{i18n.t(200675/*成功*/)}</Option>
							<Option key={0} value={'0'} title={i18n.t(300069/*未确认*/)}>失败</Option>
