...
export class AirPricePlug extends Component{
	...
	render(){
		...
		if(this.props.DialogContent == 1){
			getFieldProps('reStatus', {
							            	validateFirst: true,
						                    initialValue:1
			})
           content = (
           	<div className={'addnormal scroll'} style={{marginBottom:'10px'}}>
           		<div className={'  girdlayout'}>
											...
											<div className="row">
												...
												<div className="form-group col-md-6 col-lg-6">
							                       ...
							                       fieldName='reCcId'
							                        ...
							                        apiParams={{}}
							                         disabled={true}	    
							                         initialValue={xt.initSelectValue(ccLocalName,{s_label:ccLocalName,reCcId:Cid,reCcLcName:ccLocalName,reCcEnName:ccenName},['reCcId','reCcLcName','reCcEnName'], 's_label', this.props.form)}
							                        valueKeys={ da => ({
											...
											<div className="row">
												<div className="form-group col-md-6 col-lg-6">
													...
													<ConstVirtualSelect
													refreshMark={getFieldValue('reCcId',{}).reCcId || getFieldValue('reCcId')}
							                        placeholder=""
							                        form={this.props.form}
							                         disabled={true}	
							                       fieldName='reStaffId'
							                        ...
							                        apiParams={{
							                            ccid: getFieldValue('reCcId',{}).reCcId || getFieldValue('reCcId')
							                            
							                        }}
							                         initialValue={xt.initSelectValue(LocalName&& getFieldValue("reCcId",{}).reCcId == Cid,{s_label:LocalName,reStaffId:Ccid,reStaffLcName:LocalName,reStaffEnName:LocalEname},['reStaffId','reStaffLcName','reStaffEnName'], 's_label', this.props.form)}
							                        valueKeys={ da => ({
												         reStaffId: da.id,
											...
											<div className="row">
												<div>
													<label style={{display:'inline-block',color:'#70aae3'}}>{i18n.t(500128/*运价*/)}</label>
												</div>
											</div>
												  	...
												  	getTermModes.airMeasure.map((e,i)=>{
												  		return (<li key={i}>
															...
															type="text" {...getFieldProps('prices.'+e.id, {
						                                		initialValue:'',
						                                		rules:[{required:(e.id=="P0"||e.id=="P45"),pattern:xt.pattern.positiveNonZero}],
						                           				 })} className={getFieldError('prices.'+e.id)?"col-md-8 col-lg-8 text-input error-border":"col-md-8 col-lg-8 text-input"} placeholder={i18n.t(500273/*请输入数字*/)}/>
												  	</li>);
												  })
												}
											</ul>
											...
											<div className="row">
												...
												<div className="form-group col-md-6 col-lg-6">
							                       ...
							                       fieldName='reCcId'
							                        ...
							                        apiParams={{}}
							                         disabled={true}	    
							                         initialValue={xt.initSelectValue(checkedData,{s_label:checkedData.reCcLcName,reCcId:checkedData.reCcId,reCcEnName:checkedData.reCcEnName,reCcLcName:checkedData.reCcLcName},['reCcId','reCcLcName','reCcEnName'], 's_label', this.props.form)}
							                        valueKeys={ da => ({
												  		...
												  		return (<li key={i}>
															...
															type="text" {...getFieldProps('prices.'+e.id, {
						                                		...
						                                		initialValue:checkedData.prices && checkedData.prices[e.id]?checkedData.prices[e.id]:''
						                           				 })} className={getFieldError('prices.'+e.id)?" text-input error-border":"col-md-8 col-lg-8 text-input"} placeholder={i18n.t(500273/*请输入数字*/)}/>
												  	</li>);
												  })
												}
											</ul>
