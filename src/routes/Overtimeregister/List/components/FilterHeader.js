			...
			domFilter=(
				<div className={'filter-header'}>
                    ...
                    <div className={'filter-header-information-pre'}>
                        ...
                        <ConstMiniSelect form={this.props.form}
                                         ...
                                         pbj={{
                                             ...
                                             params:{typeAttributeIds:[41,42,43,44],partyId:getFieldValue('ccId',{}).ccId||getFieldValue('ccId')}
                                         }} fieldName="depmntId"
                                         initValueOptions={[]}
                                         optionValue={da => <Option key={da.id} objValue={{
                                             depmntId: da.id,
                                             s_label: da.localName
                                         }}>{da.localName}</Option>} allowClear
                                         style={{width: 200}}
					...
					<div className={this.state.minor}>
						<label>{I18n.t(500358/*登记人*/)}</label>
                        <input type="text" {...getFieldProps('registerLcName', {
                            initialValue:''
