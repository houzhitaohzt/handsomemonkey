    ...
    onSaveAndClose() {
        ...
        form.validateFields((errors, value) => {
            if (errors) {
                ...
                value = Object.assign({}, value, {slid: this.props.treeInfo.props.eventKey});
                if (this.props.otherData) {
                    value = this.props.form.getFieldsValue();
                    value = Object.assign({}, this.props.otherData, value, {slid: that.props.otherData.slid});
                }
                apiPost(API_FOODING_DS, '/storArea/save', value,
                    (response) => {
                ...
                <div className={'row'}>
                    <div className="form-group col-xs-6 col-md-6">
                        ...
                        {/*<Select*/}
                            {/*{...getNFieldProps('clusId', {*/}
                                {/*rules: [{required: true}],*/}
                                {/*initialValue: treeInfo.cluster ? {*/}
                                    {/*s_label: treeInfo.cluster.localName,*/}
                                    {/*clusId: treeInfo.cluster.id*/}
                                {/*} : undefined*/}
                            {/*})}*/}
                        ...
                        {/*>*/}
                            {/*{this.state.jiTuanArray.map((o, i) => <Option key={i} value={String(o.id)}*/}
                    ...
                    <div className="form-group col-xs-6 col-md-6">
                        ...
                        {/*<Select*/}
                            {/*{...getNFieldProps('ccid', {*/}
                                {/*rules: [{required: true}],*/}
                                {/*initialValue: treeInfo.company ? {*/}
                                    {/*s_label: treeInfo.company.localName,*/}
                                    {/*ccid: treeInfo.company.id*/}
                                {/*} : undefined*/}
                            {/*})}*/}
                            {/*onSelect={this.qiyeTuanSelect}*/}
                            {/*placeholder=''*/}
                            ...
                            {/*className={getFieldError('ccid') ? 'currency-btn select-from-currency col-xs-8 col-md-8 error-border' : 'currency-btn select-from-currency col-xs-8 col-md-8'}*/}
                        {/*>*/}
                            {/*{this.state.qiyeArray.map((o, i) => <Option key={i} value={String(o.id)}*/}
                                                                        {/*title={o.name}>{o.name}</Option>)}*/}
                        {/*</Select>*/}
                    </div>
                </div>
                <div className={'row'}>
                    <div className="form-group col-xs-6 col-md-6">
                        ...
                        {/*<Select*/}
                            {/*{...getNFieldProps('plntId', {*/}
                                {/*rules: [{required: true}],*/}
                                {/*initialValue: treeInfo.plant ? {*/}
                                    {/*s_label: treeInfo.plant.localName,*/}
                                    {/*plntId: treeInfo.plant.id*/}
                                {/*} : undefined*/}
                            {/*})}*/}
                            {/*allowClear*/}
                            {/*placeholder=''*/}
                            ...
                            {/*className={getFieldError('plntId') ? 'currency-btn select-from-currency col-xs-8 col-md-8 error-border' : 'currency-btn select-from-currency col-xs-8 col-md-8'}*/}
                        {/*>*/}
                            {/*{this.state.zuzhiArray.map((o, i) => <Option key={i} value={String(o.id)}*/}
                                                                         {/*title={o.name}>{o.name}</Option>)}*/}
                        {/*</Select>*/}
                    </div>
                </div>
