...
export function generateData(x = 2, y = 3, z = 1, gData = []) {
  ...
  gData =[{
      ...
      children:[
        {key:'0-1',title:i18n.t(201255/*辛店*/),
        children:[{key:'0-1-0',title:i18n.t(201256/*合格品区*/),
                  children:[{key:'0-1-0-0',title:'5排3列2层'}]},
                  {key:'0-1-1',title:i18n.t(201257/*不合格区*/),
                  children:[{key:'0-1-1-1',title:'12排9列1层'}]}
        ]},
        {key:'0-2',title:i18n.t(200906/*浦东仓库*/)},
        {key:'0-3',title:i18n.t(201258/*闵行仓库*/)}
      ]
    }];
