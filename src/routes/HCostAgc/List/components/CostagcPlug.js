												 ...
												 <div className="form-group col-xs-6 col-md-6">
													...
													<input placeholder=''
															type="text" {...getFieldProps('costAgg', {
						                                			...
						                                			initialValue:''
						                           				 })}  placeholder={i18n.t(500273/*请输入数字*/)} className={getFieldError('costAgg')?'col-md-9 col-lg-9 text-input-nowidth error-border':'col-md-9 col-lg-9 text-input-nowidth'}/>
												</div>
												<div className="form-group col-xs-6 col-md-6">
								...
								<div className="form-group col-md-6 col-lg-6">
													<label className={'col-md-3 col-lg-3'}>{i18n.t(500259/*发布企业*/)}</label>
								                       ...
								                       fieldName='reCcId'
								                        ...
								                        apiParams={{}}
								                         disabled={true}	    
								                         initialValue={xt.initSelectValue(otherData,{s_label:otherData.reCcLcName,reCcId:otherData.reCcId,reCcEnName:otherData.reCcEnName,reCcLcName:otherData.reCcLcName},['reCcId','reCcLcName','reCcEnName'], 's_label', this.props.form)}
								                        valueKeys={ da => ({
