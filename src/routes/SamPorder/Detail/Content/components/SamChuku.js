...
class SamChuku extends Component {
    ...
    onStockChange = value => {
        // if( !value) return this.setState({chukuarray: []});
        apiGet(API_FOODING_ERP, '/stock/getPage', {
            slId: value.receSlId, pageSize: 100, currentPage: 1,inventory:1
        }, response => {
                    ...
                    <div>
                        <div className={'  girdlayout'} >
                            <div className={'row'}>
                                ...
                                <div className="form-group col-xs-4 col-md-4">
                                    <label className={'col-md-4 col-lg-4'}>{i18n.t(200173/*样品数量*/)}</label>
                                    <input disabled type="text" className={'col-md-8 col-lg-8 text-input-nowidth'} placeholder=""
                            ...
                            <div className={'row'}>
                                ...
                                <div className="form-group col-xs-4 col-md-4">
                                    <label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(200177/*样品库*/)}</label>
