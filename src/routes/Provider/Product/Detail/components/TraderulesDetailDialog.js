						 	 ...
						 	 <div className="row">
								...
								<div className="row">
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100551/*净重量*/)}</label>
								...
								/> 
									...
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100553/*毛重量*/)}</label>
								...
								<div className="row">
									...
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100426/*体积单位*/)}</label>
								...
								<div className="row">
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100223/*体积量*/)}</label>
			...
			if(data.number == 0 || data.number == 1){
				content =(<div className="girdlayout">
						 	 <div className="row">
								...
								<div className="row">
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100598/*箱型数量*/)}</label>
								...
								<div className="row">
									...
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}><span>*</span>{i18n.t(100600/*每托盘件数*/)}</label>
