		               	...
		               	<div className = 'col'>
                            <Template1 
                                ...
                                id={'detail-normal'} title={i18n.t(100138/*常规*/)} tempArray={[
                                    {key:i18n.t(100379/*产品*/),value:data.beMtl&&data.beMtl.material?data.beMtl.material.localName:''},
                                    {key:i18n.t(200976/*供应商产品编码*/),value:data.beMtl?data.beMtl.beMtlCode:''},
                                    {key:i18n.t(200977/*供方销售员*/),value:data.beMtl&&data.beMtl.saleContactor?data.beMtl.saleContactor.localName:''},
                                    {key:i18n.t(400081/*产品操作员*/),value:data.beMtl&&data.beMtl.operContactor?data.beMtl.operContactor.localName:''},
                                    {key:i18n.t(500274/*保质期天数*/),value:data.beMtl?data.beMtl.assurDay + '('+ i18n.t(200519/*天*/) +')':''},
