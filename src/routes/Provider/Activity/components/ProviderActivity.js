...
class ProviderActivity extends Component{
	constructor(props){
		super(props);
	...
	*/
	render(){
		...
		return(<CommonActivity pageIdent='provider' type={"client"}
							   activity ={no => this.activity = no} isDetail ={true}
							   activityType={30} router={this.props.router} salBeId={salBeId}
							   salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={20}/>)
	}
}
