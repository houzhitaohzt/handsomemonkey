...
export  class  ActivityDetail extends Component{
    ...
    getOneCall(id,initAjax){
    	let that = this;
    	apiGet(API_FOODING_ERP,'/productpricing/getOne',
  	...
  	saveClick(initAjax){
  		...
  		this.props.form.validateFields((error, value) => {
			if(error){
			  ...
			  apiPost(API_FOODING_ERP,'/productpricing/save',Object.assign({},this.state.getOne,value),(response)=>{
			...
			if(error){
			  ...
			  apiPost(API_FOODING_ERP,'/productpricing/save',Object.assign({},this.state.getOne,value),(response)=>{
					...
					let done = ()=>{
			  		...
			  		// 	id:response.data
			  		// });
			  		this.props.navReplaceTab({ name: i18n.t(200950/*产品定价详情*/), component: i18n.t(200950/*产品定价详情*/), url: '/productpricing/detail'});
	        	this.props.router.push({pathname: '/productpricing/detail',query:{id:response.data}});
					};
