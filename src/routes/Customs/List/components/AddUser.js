	...
	onSaveAndClose = ()=> {
		...
		form.validateFields((errors, value) => {
			if(errors){
				...
				apiForm(API_FOODING_DS,'/customsData/connect',Object.assign(value,{id:row['id'],dataTyId:30,connectedId:row['connectedId']}),
					(response)=>{
                ...
                <div className="addnormal girdlayout">
					<div className="row">
						<div className={'col-md-10 form-group'}>
							<label className={'col-md-4'}><span>*</span>{I18n.t(100355/*客户名称*/)}</label>
