...
class Packaging extends Component{
	...
	initState(){
		return {
			...
			choised:false,
			data:null,
			record:[{'code':'SPK2015986','name':'700 KG PLADGHSGSF ADFRHDFGDAGDSFGDS','description':i18n.t(200806/*常用*/)},{'code':'SPK2015986','name':'700 KG PLADGHSGSF ADFRHDFGDAGDSFGDS','description':i18n.t(200806/*常用*/)},{'code':'SPK2015986','name':'700 KG PLADGHSGSF ADFRHDFGDAGDSFGDS','description':i18n.t(200806/*常用*/)},{'code':'SPK2015986','name':'700 KG PLADGHSGSF ADFRHDFGDAGDSFGDS','description':i18n.t(200806/*常用*/)},{'code':'SPK2015986','name':'700 KG PLADGHSGSF ADFRHDFGDAGDSFGDS','description':i18n.t(200806/*常用*/)}]
		}
	}
	addClick(){
		let content =require('./PackagingAddAndEditDialog').default;
		let element=React.createElement(content,{onSaveAndClose:this.onSaveAndClose,onCancel:this.onCancel});
    	this.setState({
    		showDilaog : true,
    		title:i18n.t(200807/*新增包装*/),
	...
	onRowDoubleClick(record,index,checked){
		let content =require('./PackagingViewDialog').default;
		let element=React.createElement(content,{onSaveAndClose:this.onSaveAndClose,onCancel:this.onCancel});
    	this.setState({
    		showDilaog : true,
    		title:i18n.t(100028/*包装详情*/),
    		dialogContent : element
    	})
	}
	handleClick=(e,data) => {
...
export default NavConnect(Packaging);
