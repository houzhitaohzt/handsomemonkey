...
class ForwarderContactDate extends Component{
	constructor(props){
		super(props)
	...
	*/
	render(){
		...
		return(<DsContactDate pageIdent='forwarderLinkman' type={"forwardercontactdate"} activityType={10}
...
export default ForwarderContactDate;