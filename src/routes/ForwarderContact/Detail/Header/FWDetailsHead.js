...
export  class  FWDetailsHead extends Component{
	    constructor(props) {
	        ...
	        this.array =[];
					let navTabs=[
						{name:i18n.t(100097/*详情*/),url:'/forwardercontact/detail',id:'detail',isLoading:false},
						{name:i18n.t(100586/*邮件*/),url:'/forwardercontact/email',id:'email',isLoading:false},
						{name:i18n.t(100585/*市场活动响应*/),url:'/forwardercontact/activity',id:'activity',isLoading:false},
						{name:i18n.t(100587/*约会*/),url:'/forwardercontact/date',id:'date',isLoading:false},
						{name:i18n.t(100588/*联络*/),url:'/forwardercontact/contact',id:'contact',isLoading:false},
						// {name:'历史记录',url:'/servcon/history',id:5},
						{name:i18n.t(100136/*附件*/),url:'/forwardercontact/accessory',id:'accessory',isLoading:false},
						{name:i18n.t(100148/*注释*/),url:'/forwardercontact/annotation',id:'annotation',isLoading:false}
			];
						...
						<div className="box5">
								<div className="top">
										<div className="box6">
												...
												<div className="gery">
													<div className="flex"><div className="nation"><span>{i18n.t(100299/*货代公司*/)}</span><b>{value.enterprise?value.enterprise.localName:''}</b></div></div>
