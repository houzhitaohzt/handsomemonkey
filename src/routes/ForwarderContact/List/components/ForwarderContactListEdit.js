...
export class  ContactDialog extends Component{
	...
	lbizPrnClick(){
		...
		if(this.props.form.getFieldValue("beId")){
			...
			apiGet(API_FOODING_DS,'/entContact/getByBeIdDataTyId',{beId:beId,dataTyId:130},
				(response)=>{
					that.setState({
		...
		this.props.form.validateFields((error, value) => {
			if(error){
				...
				if(this.props.data){
				   ...
				   var contactList = [{name:value.email,linkTyId:80,dfutMark:true,dataTyId:130},
				   {name:value.defaultMobile,linkTyId:100,dfutMark:true,dataTyId:130},
				   {name:value.skype,linkTyId:110,dfutMark:true,dataTyId:130}];
					delete value.email;
					delete value.defaultMobile;
					delete value.skype;
					value=Object.assign({},value,{contactList:contactList});
				}
	      		value = Object.assign({},value,{dataTyId:130});
