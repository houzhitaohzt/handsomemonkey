...
export  class  CompetitorsDetailsHead extends Component{
	    constructor(props) {
	        ...
	        this.array =[];
					let navTabs=[
						{name:I18n.t(100097/*详情*/),url:'/competitors/detail',id:'detail',isLoading:false},
						{name:I18n.t(100350/*关注产品*/),url:'/competitors/focuproduct',id:'product',isLoading:false},
						{name:i18n.t(100136/*附件*/),url:'/competitors/accessory',id:'accessory',isLoading:false},
						{name:i18n.t(100148/*注释*/),url:'/competitors/annotation',id:'annotation',isLoading:false},
                        {name: i18n.t(300083/*组织关系*/), url: '/competitors/organizational/', id: 'organizational',isLoading:false},
			];
