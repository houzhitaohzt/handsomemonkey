...
class CompetitorsList extends Component{ 
	...
	onRowDoubleClick(record,index,checked){
		...
		navAddTab({id:'forwader-detail',name:I18n.t(100449/*竞争对手*/) + I18n.t(100097/*详情*/),component:I18n.t(100449/*竞争对手*/) + I18n.t(100097/*详情*/),url:'/competitors/detail'});
		this.props.router.push({pathname:'/competitors/detail',query:{id:record.id}});
	}
	handleClick=(e,data) => {
