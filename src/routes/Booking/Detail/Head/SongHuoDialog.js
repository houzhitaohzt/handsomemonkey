	...
	onSaveAndClose(isAdd){
		...
		form.validateFields((errors, value) => {
			if(errors){
				...
				apiForm(API_FOODING_ERP,'/shipping/noticeDelivery',obj,(response)=>{
					    this.props.onCancel();
					    // this.props.onPackUp();
					...
					<div className={'  girdlayout'}>
						<div className={'row'}>
							<div className="form-group col-md-12 col-lg-12">
								<label className={'col-md-2 col-lg-2'}><span>*</span>{i18n.t(200385/*最晚到货日期*/)}</label>
								<div className={'col-md-10 col-lg-10 datetime'}>
									<DataTime 
										showTime={false}
										isShowIcon={true}
										width={'100%'}
