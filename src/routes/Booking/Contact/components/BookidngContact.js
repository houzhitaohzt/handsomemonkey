...
class BookidngContact extends Component{
	constructor(props){
		super(props)
	...
	*/
	render(){
		...
		return(<ErpContactDate  type={"booking"} activityType={20}
								contact ={no => this.contact = no} isDetail ={true}
								router={this.props.router} salBeId={salBeId} salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={80} originalId={originalId}/>)
	}
}
export default BookidngContact;