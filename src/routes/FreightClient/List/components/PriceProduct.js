    ...
    render() {
        ...
        return (<div className="client-price-content-table" style={{paddingTop:'10px'}}>
            ...
            <div className="content-button">
                <i className='foddingicon fooding-arrow-right_16 move-right' onClick={this.rightClick.bind(this)}/>
                <i className='foddingicon fooding-arrow_left_16 move-left' onClick={this.leftClick.bind(this)}/>
            </div>
