...
const typeLink = {
    'client':"/clientcontact/email",
    'provider':"/providercontact/email",
    'forwarder':"/forwardercontact/email",
    'servbe':"/servbe/email"
}
const typeComponent = {
...
class MailDefault extends Component {
    ...
    onMailClick = data => {
        ...
        this.props.router.push({pathname:typeLink[this.props.type],query:{id:data.id}});
    }
    //点击邮件，跳转到写邮件页面
    onEmailClick = (data,e) => {
