...
class ClientDate extends Component{
	constructor(props){
		super(props);
	...
	*/
	render(){
		...
		return(<DsContactDate pageIdent="client" type={"client"} salBeId={salBeId}  date ={no => this.date = no} isDetail ={true}
							  router={this.props.router} salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={10}/>)
	}
}
