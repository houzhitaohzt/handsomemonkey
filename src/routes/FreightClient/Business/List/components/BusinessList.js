...
class BusinessList extends Component{
	...
	handleClick = (e, data) => {
        if (data.action == i18n.t(100439/*编辑*/)) {
            ...
            navAddTab({name: name, component: name, url: '/businessOpportunity/contact/' + billId});
            this.props.router.push({pathname: '/businessOpportunity/contact/' + billId, query: {id: billId}});
            ...
            let name = i18n.t(100321/*商机*/) + '(' + data.record.no + ")";
            let billId = data.record.billId;
            navAddTab({name: name, component: name, url: '/businessOpportunity/date/' + billId});
            this.props.router.push({pathname: '/businessOpportunity/date/' + billId, query: {id: billId}});
