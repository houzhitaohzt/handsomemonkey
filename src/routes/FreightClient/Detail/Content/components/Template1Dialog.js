...
export class  Dialog1 extends Component{
	...
	render(){
        ...
        customer.cstmLevel = customer.cstmLevel || {};
        customer.cstmType = customer.cstmType || {};
        customer.incotm = customer.incotm || {};
        customer.country = customer.country || {};
        customer.cstmCrsekt = customer.cstmCrsekt || {};
        ...
        if(data.name.id == "client-detail-normal"){
			...
			content = (<div className={'girdlayout'}>
				...
				<div className={'row'}>
					...
					<div className="form-group col-md-6 col-lg-6">
						<label className={'col-md-3 col-lg-3'}>{I18n.t(100362/*客户来源*/)}</label>
						<ConstVirtualSelect
							form={this.props.form}
							isRequest={false}
							fieldName="cstmSrcId"
