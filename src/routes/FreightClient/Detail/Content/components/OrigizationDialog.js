					...
					<div className={'  girdlayout'} >
						...
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								...
								<ConstMiniSelect form={this.props.form} 
									isRequest={Boolean(getFieldValue("ccid",initData&&initData.company?initData.company.id:''))}
									refreshMark={getFieldValue("ccid",initData&&initData.company?initData.company.id:'')} 
									 pbj={{
										apiType:apiGet,
										 host:API_FOODING_ES,
										 uri: '/user/getListForPermissionsInParty',
										 params:{typeAttributeIds:partyTypeId,partyId:getFieldValue("ccid",initData&&initData.company?initData.company.id:'')}
									}} fieldName="staffIds"
										props={{tags: true}}
