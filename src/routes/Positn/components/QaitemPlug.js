...
export class QaitemPlug extends Component{
	constructor(props){
		super(props);
		this.addSelect;
						...
						<div className={'row'}>
								<div className="form-group col-md-6 col-lg-6">
									...
									<ConstMiniSelect form={this.props.form}
				             				 pbj='com.fooding.fc.ds.entity.Depmnt' 
                                             fieldName="depmntId"
						...
						<div className={'row'}>
								...
								<div className="form-group col-md-6 col-lg-6">
									...
									<ConstMiniSelect form={this.props.form}
                                             ...
                                             optionValue={da => <Option key={da.id} objValue={{
                                                 depmntId: da.id,
                                                 depmntName: da.localName,
                                                 s_label: da.localName
                                             }}>{da.localName}</Option>}
                                             	reles={true}
                                             	initialValue={xt.initSelectValue(checkedData,{depmntId:checkedData.depmntId,depmntName:checkedData.depmntName},['depmntId'], 'depmntName', this.props.form)}
                                             className ={'col-md-8 col-lg-8 currency-btn select-from-currency'}
                                              allowClear
				                 	/>
								</div>
				...
				<div className={'girdlayout scroll'} style={{overflow:'auto'}}>
					...
					<div className={'row'}>
					    <div className="form-group col-xs-6 col-md-6">
							<label className={'col-xs-4 col-md-4'}>{I18n.t(100238/*部门*/)}</label>
							<div className={'col-xs-8 col-md-8'}>
								<p>{checkedData.record.depmntName}</p>
							</div>
						</div>
						<div className="form-group col-xs-6 col-md-6">
...
const ProductForm =createForm()(QaitemPlug);
