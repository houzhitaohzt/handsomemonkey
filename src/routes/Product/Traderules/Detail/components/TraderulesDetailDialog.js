								...
								<div className="form-group col-xs-6 col-md-6">
										...
										<Select
											...
											{...getNFieldProps('certifctId',{
												validateFirst: true,
												rules: [{required:true,}],
												initialValue:initData.tradruleCertfct?initData.tradruleCertfct.certifctId:undefined,
											})}>
											{
												certfcts.map((e,i) =>{
													return (<Option key={i} value={e.id} title={e.name}>{e.localName}</Option>)							
												})
											}
										</Select>
								</div>
						 	 ...
						 	 <div className="row">
								<div className="form-group col-xs-6 col-md-6">
										...
										<Select
											...
											{...getNFieldProps('cntryId',{
												validateFirst: true,
												rules: [{required:true,}],
												initialValue:initData.tradruleAntidump?initData.tradruleAntidump.cntryId:undefined,
											})}>
											{
												countrys.map((e,i) =>{
													return (<Option key={i} value={e.id} title={e.name}>{e.name}</Option>)							
								...
								<div className="form-group col-xs-6 col-md-6">
											...
											<Input 
												...
												initialValue:initData.tradruleAntidump?(initData.tradruleAntidump.antiDumpRuty?initData.tradruleAntidump.antiDumpRuty : ''):''}}
											/>
									</div>
								</div>
								<div className="row">
						 	 ...
						 	 <div className="row">
								<div className="form-group col-xs-6 col-md-6">
										...
										<Select
											...
											{...getNFieldProps('itemId',{
												validateFirst: true,
												rules: [{required:true,}],
												initialValue:initData.tradruleShipmark?initData.tradruleShipmark.itemId:undefined,
											})}>
											{
												items.map((e,i) =>{
													return (<Option key={i} value={e.id} title={e.name}>{e.name}</Option>)							
								...
								<div className="form-group col-xs-6 col-md-6">
										...
										<Input 
											...
											classn:'col-xs-8 col-md-8 text-input-nowidth',
											initialValue:initData.tradruleShipmark?(initData.tradruleShipmark.itemTxt?initData.tradruleShipmark.itemTxt:''):''}}
										/>
								</div>
							</div>
						</div>);
						 	 ...
						 	 <div className="row">
								...
								<div className="form-group col-xs-6 col-md-6">
										...
										<Input 
											...
											classn:'col-xs-8 col-md-8 text-input-nowidth',
											initialValue:initData.tradrulePropty?(initData.tradrulePropty.infoTxt?initData.tradrulePropty.infoTxt:''):''}}
										/>
								</div>
							</div>
						</div>);
						...
						<div className="girdlayout">
						 	 <div className="row">
								<div className="form-group col-xs-12 col-md-12">
							            ...
							            <Input 
											form={this.props.form} 
											obj={{name:'description',type:'text',
											classn:'col-xs-10 col-md-10 text-input-nowidth',
											initialValue:initData.tradruleAntidump?initData.tradruleAntidump.description:''}} 
										/>
								</div>
							</div>
							<div className="row">
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}>{i18n.t(200873/*禁止开始日期*/)}</label>
										<div className={'col-md-8 col-lg-8 datetime'}>
											<Calendar 
												showTime={false}
												isShowIcon={true}
									...
									<div className="form-group col-md-6 col-lg-6">
										<label className={'col-md-4 col-lg-4'}>{i18n.t(200874/*禁止结束日期*/)}</label>
										<div className={'col-md-8 col-lg-8 datetime'}>
											<Calendar 
												showTime={false}
												isShowIcon={true}
