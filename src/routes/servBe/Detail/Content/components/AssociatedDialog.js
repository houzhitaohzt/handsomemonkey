...
export class  AssociatedDialog extends Component{
	constructor(props){
		super(props);
		let that = this;
	...
	render(){
				...
				SelectDom = (<div className="form-group col-xs-6 col-md-6">
							...
							<Select
	                            ...
	                            placeholder={I18n.t(100477/*请搜索*/)}
	                             className ={getFieldError('prtnBeId')?'currency-btn select-from-currency col-xs-8 col-md-8 error-border':'currency-btn select-from-currency col-xs-8 col-md-8'}
		...
		return(
			<div className="action-normal-buttons">
				<FormWrapper showFooter={true} onSaveAndClose={this.onSaveAndClose} onCancel={this.onCancel} width={976} onSaveAdd={this.onSaveAdd} showSaveAdd={!data.number == 0}>
...
AssociatedDialog.propTypes ={
	onSaveAdd:PropTypes.func,
	onSaveAndClose:PropTypes.func,
    onCancel:PropTypes.func
}
AssociatedDialog.defaultProps ={
	onSaveAdd(){},
	onSaveAndClose(){},
    onCancel(){}
}
const AssociatedForm =createForm()(AssociatedDialog);
