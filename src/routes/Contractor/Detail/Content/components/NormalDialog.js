...
export class  NormalDialog extends Component{
	...
	render(){
		...
		let content;
		if(data.name.id == 'carrier-detail-normal'){//表示承运人详情常规
			let {carrier,countrys} = initData;
			carrier.country =carrier.country || {};
			this.data = Object.assign({},carrier,{title:"carrier-detail-normal"});
			content=(<div className={'girdlayout'}>
					<input type="hidden" {...getFieldProps('id', {
                                initialValue:carrier&&('id' in carrier)?carrier.id:''
                            })} />
					<div className={'row'}>
						<div className="form-group col-md-6 col-lg-6">
							<label className={'col-md-3 col-lg-3'}><span>*</span>{I18n.t(600215/*承运人代码*/)}</label>		
                            <input type="text" {...getFieldProps('code', {
                            	validateFirst: true,
								rules: [{required:true,}],
                                initialValue:carrier&&('code' in carrier)?carrier.code:''
						...
						<div className="form-group col-md-6 col-lg-6">
							...
							<ConstVirtualSelect
								...
								initialValue={carrier&&('country' in carrier)?carrier.country.id:''}
					...
					<div className={'row'}>
						<div className="form-group col-md-6 col-lg-6">
							...
							<NameCheck
								...
								fieldName='name'
								rules={true}
								initialValue={carrier&&carrier.name?carrier.name:''}
								className={'col-md-9 col-lg-9'}
							/>					
						</div>
						<div className="form-group col-md-6 col-lg-6">
							...
							<NameCheck
								...
								rules={true}
								isEnName={true}
								initialValue={carrier&&carrier.enName?carrier.enName:''}
								className={'col-md-9 col-lg-9'}
							/>
						</div>
					</div>
					<div className={'row'}>
						<div className="form-group col-md-6 col-lg-6">
                            ...
                            <input type="text" {...getFieldProps('description', {
                                initialValue:carrier&&('description' in carrier)?carrier.description:''
                            })} className ={'col-md-9 col-lg-9 text-input-nowidth'} />
						</div>
					</div>						
			</div>)
		}else if(data.name.id == 'carrier-detail-signInformation'){//表示服务机构注册信息
			
			let carrier = initData;
		let taxIdenSN = getFieldProps('taxIdenSN', {
            normalize: fieldsFormat.taxIdenSN,
            initialValue:carrier.taxIdenSN?String(carrier.taxIdenSN):''
        });
        ...
        let taxIdenComp = <input type="text" value={taxIdenSN.value} onChange={(...args)=>taxIdenSN.onChange(...args)}
			...
			this.data = Object.assign({},carrier,{title:"carrier-detail-signInformation"});
			content=(<div className={'  girdlayout'}>
					<input type="hidden" {...getFieldProps('id', {
                                initialValue:carrier&&('id' in carrier)?carrier.id:''
                            })} />
					<div className={'row'}>
						...
						<div className="form-group col-md-6 col-lg-6">
							...
							<input type="text" {...getFieldProps('leglpsn', {
                                initialValue:carrier.leglpsn?carrier.leglpsn:''
					...
					<div className={'row'}>
						<div className="form-group col-md-6 col-lg-6">
                            ...
                            <div className={'col-md-9 col-lg-9 datetime'}>
								<Calendar 
									...
									name={'estabDate'}
									value={carrier.estabDate?new Date(carrier.estabDate).Format('yyyy-MM-dd'):""}										
								/>
                            </div>
						</div>
						<div className="form-group col-md-4 col-lg-4">
	                        ...
	                        <input type="text" {...getFieldProps('regCapital', {
		                            initialValue:carrier.regCapital?carrier.regCapital:'',
						...
						<div className="form-group col-md-2 col-lg-2">
	                       ...
	                       <ConstVirtualSelect
								...
								initValueOptions={carrier&&carrier.regCapitalCurren?[{id:carrier.regCapitalCurren.id,localName:carrier.regCapitalCurren.localName}]:[]}
								initialValue={carrier&&carrier.regCapitalCurren?carrier.regCapitalCurren.id:''}
			...
			commonInit.cluster = commonInit.cluster || {};
			commonInit.cluster = commonInit.cluster || {};
