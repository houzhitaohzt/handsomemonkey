...
export class Clentlist extends Component{
    ...
    addClick(e){
        ...
        this.setState({
                        ...
                        title_1:'',
                        contentTemplate:<ContactDialog data ={{record:{country},type:2}}
    ...
    deleteClick(e){
        ...
        if(array.length==0){
            ...
            DeleteDialog(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
                     ...
                     apiForm(API_FOODING_DS,'/carrierLinkMan/delete',{id:id},(response)=>{
    ...
    handleClick(e,data,target){
        ...
        if(data.type == 7){
           this.deleteClick();
            ...
            let str ='/carrierLinkMan/getOne';
            apiGet(API_FOODING_DS,str,{id:data.record.id},(response)=>{
                that.setState({
                    rodalShow:true,
                    title:tit,
                    title_1:'',
                    contentTemplate:<ContactDialog data ={{record:response.data,type:2}}  id={this.state.id}
    ...
    getPage(currentPage,objValue){
        ...
        let object=Object.assign({},{pageSize: this.state.pageSize, currentPage: currentP,beId:getQueryString("id")});
        apiGet(API_FOODING_DS,'/carrierLinkMan/getPage',object,
                (response)=>{   
                    that.setState({ 
