...
export class SalesOrderDetail extends Component{
    ...
    pay(){
        ...
        Confirm(i18n.t(200043/*确定*/)+i18n.t(400040/*付款申请*/), {
                ...
                apiForm(API_FOODING_ERP,'/chargecollect/payapply',{billId:getOneData['billId']},
                    (response)=>{	
    ...
    shall(){
        ...
        Confirm(i18n.t(200043/*确定*/)+i18n.t(500149/*撤销*/), {
                ...
                apiForm(API_FOODING_ERP,'/chargecollect/cancel',{billId:getOneData['billId']},
                    (response)=>{	
                        ServiceTips({text:response.message,type:'success'});
    ...
    charge = ()=>{
        ...
        Confirm(i18n.t(200043/*确定*/)+i18n.t(200408/*费用确认*/), {
                ...
                apiForm(API_FOODING_ERP,'/chargecollect/confirmnotice',{billId:that.props.location.query['id']},
                    (response)=>{	
                        ServiceTips({text:response.message,type:'success'});
                        that.getOne();
                        that.getList();
    ...
    edit(){
		...
		navReplaceTab({id:13,name:i18n.t(500246/*费用归集编辑*/),component:i18n.t(500246/*费用归集编辑*/),url:'/hchargecollect/add'});
		this.props.router.push({ pathname: '/hchargecollect/add',query:{id:this.props.location.query['id']}});
    }
    //费用单提交
    commit(){
		let that = this;
    ...
    delete(){
        ...
        Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
                ...
                apiForm(API_FOODING_ERP,'/chargecollect/delete',{billId:getOneData['billId']},
                    (response)=>{	
                        ServiceTips({text:response.message,type:'success'});
                        let {navReplaceTab} = this.props;
                            navReplaceTab({ name: i18n.t(500248/*费用归集*/), component: i18n.t(500248/*费用归集*/), url: '/hchargecollect/list'});
                            this.props.router.push({pathname: '/hchargecollect/list',state: {refresh: true}});                
                    },(errors)=>{
                        ServiceTips({text:errors.message,type:'error'});
                });
	...
	render(){
		...
		return (
			  <div className='activity-detail  scroll' style={{height:this.state.scrollHeight}}>
	               <NormalDetail getOneData={getOneData} shall={this.shall} pay ={this.pay}  commit ={this.commit}  edit ={this.edit} delete={this.delete}
