...
class ProviderContactContact extends Component{
	constructor(props){
		super(props)
	...
	*/
	render(){
		...
		return(<DsContactDate pageIdent='providerLinkman' type={"providercontactcontact"} activityType={20}
...
export default ProviderContactContact;