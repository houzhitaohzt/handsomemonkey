							...
							<div className="train" key={i}>
								<div className="top">
									...
									<span style={{flex:1,color:'#3d495a',textAlign:'right',paddingRight:'20px'}}>
											...
											{dataItem.reStatus!=0 && permissionsBtn('forwtruckPrice.copy')? <i  style={{marginRight:'25px'}} onClick ={this.copyClick.bind(this,dataItem)} className="foddingicon fooding-copy"></i> : ''}	
											{dataItem.reStatus!= 0 && dataItem.reStatus!= 35 && permissionsBtn('forwtruckPrice.delete')? <i style={{marginRight:'25px'}} onClick ={this.deleteClick.bind(this,dataItem)} className="foddingicon fooding-delete-icon4"></i> : ''}
											{dataItem.reStatus!= 0 && dataItem.reStatus!= 35 && dataItem.reStatus!= 38 && permissionsBtn('forwtruckPrice.edit')? <i onClick ={this.editClick.bind(this,dataItem)} className="foddingicon fooding-alter_icon2"></i> : ''}
											{dataItem.reStatus!= 0 && dataItem.reStatus!= 1 && dataItem.reStatus!= 38 && permissionsBtn('forwtruckPrice.void')? <i onClick ={this.zuofeiBtnClick.bind(this,dataItem)} title={i18n.t(100471/*作废*/)} className="foddingicon fooding-ivoid"></i>: ''}
