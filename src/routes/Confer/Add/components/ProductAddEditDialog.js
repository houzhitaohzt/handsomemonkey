							...
							<div className="form-group col-xs-3 col-md-3">
								...
								<ConstMiniSelect form={this.props.form}				
									pbj="com.fooding.fc.ds.entity.Unitofmea"
		                             ...
		                             initialValue={xt.initSelectValue(initData.uomId && getFieldValue("mtlId",{}).mtlId, initData, ['uomId', 'uomLcName', 'uomEnName'], 'uomLcName', this.props.form)}
						...
						<div className={'row'}>
							...
							<div className="form-group col-xs-3 col-md-3">
								...
								<ConstMiniSelect form={this.props.form} pbj='com.fooding.fc.ds.entity.Curren' fieldName="cnyId"
		                             ...
		                             initialValue={xt.initSelectValue(initData.cnyId && getFieldValue("mtlId",{}).mtlId, initData, ['cnyId', 'cnyLcName', 'cnyEnName'], 'cnyLcName', this.props.form)}
