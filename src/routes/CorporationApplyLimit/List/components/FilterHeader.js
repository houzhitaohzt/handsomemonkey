			...
			domFilter=(
				<div className={'filter-header'}>
					<div className={'filter-header-information-pre'}>
						<label>{i18n.t(200522/*买方代码*/)}</label>
					...
					<div className={'filter-header-information-pre'}>
						<label>{i18n.t(200523/*信保限额状态*/)}</label>
						<Select
						...
						>
							...
							<Option key={2} value={'15'} title={i18n.t(200486/*不予审批*/)}>{i18n.t(200486/*不予审批*/)}</Option>
							<Option key={2} value={'20'} title={i18n.t(200487/*已撤销*/)}>{i18n.t(200487/*已撤销*/)}</Option>
						</Select>						
					</div>					
