...
export class Addnormal extends Component{
	...
	render(){
        ...
        return 	<FormWrapper showSaveAdd={data.number} showSaveClose={1} showFooter={true} onSaveAdd={this.onSaveAndClose} onSaveAndClose={this.onSaveAndClose.bind(this,true)} onCancel={this.onCancel}>
                        ...
                        <div className={'row'}>
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    {/*<Select
                                        {...getNFieldProps('sourceNo',{
                                            //rules: [{required:true}],
                                            initialValue: data.number == 0 ? data.record['sourceNo'] : '',
                                        })}
                                        placeholder=''
                                        optionLabelProp="children"
                                        optionFilterProp="children"
                                        className ={getFieldError('sourceNo')?'costName-btn select-from-costName col-md-8 error-border':'costName-btn select-from-costName col-md-8 col-lg-8'}
                                        onClick={this.handleNumber}
                                    >
                                        {this.state.number.map((o,i)=><Option key={i} objValue={{s_label:String(o),sourceNo:o}} title={String(o)}>{String(o)}</Option>)}
                                    </Select>*/}
                                </div>
                                :<b></b>
                            }
                            <div className="form-group col-md-6">
                                ...
                                <Select
                                    ...
                                    optionLabelProp="children"
                                    optionFilterProp="children"
                                    className ={getFieldError('costlvtrId')?'currency-btn select-from-currency col-md-8 error-border':'currency-btn select-from-currency col-md-8 col-lg-8'}
                        ...
                        <div className={'row'}>
                            <div className="form-group col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    placeholder={''}
                                    className ={getFieldError('actCost')?'col-md-8 text-input-nowidth error-border':'col-md-8 text-input-nowidth'}
                                />
                            </div>
                            <div className="form-group col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    placeholder={''}
                                    className ={getFieldError('remark')?'col-md-8 text-input-nowidth error-border':'col-md-8 text-input-nowidth'}
                                />
                            </div>                            
                        </div>
                        <div className={'row'}>
