...
class ClientContactDate extends Component{
	constructor(props){
		super(props)
	...
	*/
	render(){
		...
		return(<DsContactDate pageIdent='clientLinkman' type={"clientcontactdate"} activityType={10}
							  date ={no => this.date = no} isDetail ={true}
							  router={this.props.router} salBeId={salBeId} salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={120}/>)
	}
}
export default ClientContactDate;