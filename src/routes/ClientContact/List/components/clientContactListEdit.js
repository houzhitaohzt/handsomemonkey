...
export class ContactDialog extends Component {
            ...
            if (error) {
                ...
                if (this.props.data) {
                    ...
                    var contactList = [{
                        ...
                        dfutMark: true,
                        id: defaultEmailId,
                        optlock: defaultEmailOptlock,
                        dataTyId: 100,
                        isOfferRec: aa.defaultEmail.isOfferRec
                    },
                        {
                            name: value.defaultMobile,
                            linkTyId: 100,
                            dfutMark: true,
                            id: defaultMobileId,
                            optlock: defaultMobileOptlock,
                            dataTyId: 100
                        },
                        {
                            name: value.skype,
    ...
    render() {
        ...
        content = (
            <div className="contact-edit scroll" style={{maxHeight:'310px'}}>
                    ...
                    <div className='row'>
                        ...
                        <div className='form-group col-xs-6 col-md-6'>
                            ...
                            <ConstMiniSelect form={this.props.form}
                                             ...
                                             initValueOptions={[]}
                                             initialValue={
                                                 xt.initSelectValue(getFieldValue('depmntId', {}).depmntId === (checkedData.depmnt.id || "5927f4bdeba6e648b43b94aa" ), {
                                                     positnId: checkedData.positn.id || "59898efc45cea2b1a4c4dbfd",
                                                     localName: checkedData.positn.localName || I18n.t(400037/*采购员*/)
