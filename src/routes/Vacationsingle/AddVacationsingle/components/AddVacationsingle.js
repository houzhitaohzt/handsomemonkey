...
// ajax
import {apiGet,apiPost,apiForm,API_FOODING_ES,API_FOODING_DS,API_FOODING_ERP,API_FOODING_HR,language,commonAjax,} from '../../../../services/apiCall';
export  class  ActivityDetail extends Component{
    ...
    getOne(callBack){
        let that = this;
        apiGet(API_FOODING_HR,'/leave/getOne',Object.assign({id:that.state.id},),
            (response)=>{
