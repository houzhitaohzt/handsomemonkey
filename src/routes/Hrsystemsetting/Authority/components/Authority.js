...
import RightFuncKeys from "../../WorkCalender/components/RightFuncKeys";
        ...
        return (
            <div className={'authority-content-all-show scroll'} style={{height: this.state.scroll}}>
                <div className={'data-authority'}>
                    <SystemCommonAuthorityThree onCancel={this.onCancel} title={i18n.t(201131/*数据权限*/)}
                                                zIndex={4}
