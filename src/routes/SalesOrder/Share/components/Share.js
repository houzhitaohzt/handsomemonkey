...
export class Accessory extends Component{
	...
	searchClick(){
		let that = this;
		apiGet(API_FOODING_OA,'/fastdfs/share/getList/byName',{name:this.state.searchValue,businessType:'saleNo',businessId:this.state.id},(response)=>{
	        	this.setState({
	        		data:response.data
	        	});
	...
	getPage(parent,name){
		...
		apiGet(API_FOODING_OA,'/fastdfs/share/getList',{businessId:id,businessType:'saleNo'},
			(response)=>{
			that.setState({
				data:response.data
			})
	...
	render(){
		...
		switch(pageIdent){
			...
			break;
			case 'product' :  // 产品
				var iconArray = [{type:'add',onClick:this.addClick,permissions:'mtl.dtl.add'},{type:'delete',onClick:this.deleteClick,permissions:'mtl.dtl.del'}];
			break;
			case 'platformProduct' :  // 平台产品
				var iconArray = [{type:'add',onClick:this.addClick,permissions:'platform.mtl.dtl.add'},{type:'delete',onClick:this.deleteClick,permissions:'platform.mtl.dtl.del'}];
			break;
			case 'server' :  // 服务机构
			...
			break;
			case 'staffer' :  // 职员
				var iconArray = [{type:'add',onClick:this.addClick,permissions:'staff.dtl.add'},{type:'delete',onClick:this.deleteClick,permissions:'staff.dtl.del'}];
			break;
			default:
