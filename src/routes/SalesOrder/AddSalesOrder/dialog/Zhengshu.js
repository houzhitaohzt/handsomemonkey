...
class CommonForm extends Component{
    ...
    getEditOne = billDtlId => {
        ...
        apiGet(API_FOODING_ERP, '/saleorder/card/getOne', {id: billDtlId},
            response => {
	...
	onSaveAndClose(isAdd){
		this.props.form.validateFields((error, value) => {
			if(error){
				...
				apiPost(API_FOODING_ERP,'/saleorder/card/save',value,(response)=>{
			...
			content =(
						<div className={'  girdlayout'} style={{height:"344px"}}>
						  	<div className={'row'}>
												...
												<div className="form-group col-xs-6 col-md-6">
													<label className={'col-xs-3 col-md-3'}>{i18n.t(400134/*相关产品*/)}</label>
													<ConstMiniSelect form={this.props.form}
			                                                 pbj={{
