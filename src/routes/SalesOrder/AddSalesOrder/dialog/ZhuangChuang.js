		...
		let content = <div></div>
				content =	content =(
						<div className={'  girdlayout'} style={{height:"344px"}}>
							...
							<div className={'row'}>
								                <div className="form-group col-xs-12 col-md-12">
													<label className={'col-xs-2 col-md-2'}>{i18n.t(200080/*类型*/)}</label>
													<ConstMiniSelect form={this.props.form}
			                                                 pbj={{
							...
							<div className={'row'}>
								                <div className="form-group col-xs-12 col-md-12">
													...
													<ConstMiniSelect form={this.props.form}
			                                                 ...
			                                                 initValueOptions={[]}
			                                                 initialValue={
			                                                 	xt.initSelectValue(initData["splBe"+language], initData, ['splBeId','splBeLcName','splBeEnName'], "splBe"+language, this.props.form)}
			                                                 optionValue={(da, di) => <Option key={di} objValue={{
			                                                     splBeId: da.id,
