					...
					<div className={'row'}>
						<div className="form-group col-md-3 col-lg-3">
							...
							<div className={'col-md-9 col-lg-9'}>
								<p className={'paragraph'}>{data.createUserName}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-3 col-lg-3'}>{I18n.t(100144/*修改人*/)}</label>
							<div className={'col-md-9 col-lg-9'}>
								<p className={'paragraph'}>{data.updateUserName}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-3 col-lg-3'}>{I18n.t(100145/*创建时间*/)}</label>
							<div className={'col-md-9 col-lg-9'}>
								<p className={'paragraph'}>{data.payTrm?(new Date(data.payTrm["createDate"]).Format("yyyy-MM-dd")):''}</p>
							</div>
						</div>
						<div className="form-group col-md-3 col-lg-3">
							<label className={'col-md-3 col-lg-3'}>{I18n.t(100146/*修改时间*/)}</label>
							<div className={'col-md-9 col-lg-9'}>
								<p className={'paragraph'}>{data.payTrm?(new Date(data.payTrm["updateDate"]).Format("yyyy-MM-dd")):''}</p>
							</div>
						</div>
					</div>
				</div>
