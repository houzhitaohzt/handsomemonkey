...
export  class  SODetailsHead extends Component{
	    constructor(props) {
	        ...
	        this.array =[];
					let navTabs=[
						{name:i18n.t(100097/*详情*/),url:'/Overtimeregister/detail',id:'detail',isLoading:false},
						{name:i18n.t(100136/*附件*/),url:'/Overtimeregister/accessory',id:'accessory',isLoading:false},
