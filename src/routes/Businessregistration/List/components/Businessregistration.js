...
class Forwarderlist extends Component{
    ...
    addClick(){
        ...
        navAddTab({id:13,name:i18n.t(500371/*出差单新增*/),component:i18n.t(500371/*出差单新增*/),url:'/businessregistration/add'});
        this.props.router.push('/businessregistration/add');
    }
    deleteClick(data){
        ...
        if(numArr.length > 0){
            ...
            if(numArr[0].status==1){
                Confirm(I18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
                        ...
                        apiForm(API_FOODING_HR,'/evecregister/delete',{billId:value},(response)=>{
                            that.getPage();
    ...
    onRowDoubleClick(record,index,checked){
       let {navAddTab} =this.props;
        navAddTab({id:6,name:i18n.t(500373/*出差单详情*/),component:i18n.t(500373/*出差单详情*/),url:'/businessregistration/detail'});
        this.props.router.push({pathname:'/businessregistration/detail',query:{id:record.billId}});
    }
    ...
    getPage(currentPage,objValue){
        ...
        apiGet(API_FOODING_HR,'/evecregister/getPage',object,
            (response)=>{
                that.setState({
