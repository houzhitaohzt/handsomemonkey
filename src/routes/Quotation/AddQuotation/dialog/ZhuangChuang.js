...
class CommonForm extends Component{
    ...
    getEditOne = billDtlId => {
        ...
        apiGet(API_FOODING_ERP, '/saleoffer/require/getOne', {id: billDtlId},
            response => {
	...
	onSaveAndClose(isAdd){
		this.props.form.validateFields((error, value) => {
			if(error){
				...
				apiPost(API_FOODING_ERP,'/saleoffer/require/save',value,(response)=>{
		...
		let content = <div></div>
				content =	content =(
						<div className={'  girdlayout'} style={{height:"344px"}}>
						  	<div className={'row'}>
								                <div className="form-group col-xs-12 col-md-12">
													...
													<ConstMiniSelect form={this.props.form}
			                                                 pbj={{
			                                                     apiType: apiGet, host: API_FOODING_ERP, uri:'/saleoffer/mtl/getList',
							...
							<div className={'row'}>
								                <div className="form-group col-xs-12 col-md-12">
													<label className={'col-xs-2 col-md-2'}><span>*</span>{i18n.t(200080/*类型*/)}</label>
													<ConstMiniSelect form={this.props.form}
			                                                 pbj={{
							...
							<div className={'row'}>
								                <div className="form-group col-xs-12 col-md-12">
													<label className={'col-xs-2 col-md-2'}><span>*</span>{i18n.t(100313/*服务机构*/)}</label>
													<ConstMiniSelect form={this.props.form}
			                                                 pbj={{
			                                                     apiType: apiPost, host: API_FOODING_DS, uri:'/object/getMiniList',
