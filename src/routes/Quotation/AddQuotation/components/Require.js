    ...
    producthandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/mtl/delete',{id:select.billDtlId},(response)=>{
    ...
    maitouhandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/marks/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
		        		this.initMatou();
		        	},(error)=>{
						ServiceTips({text:error.message,type:'error'});
     ...
     zhengshuhandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/card/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
		        		this.initZhengshu();
		        	},(error)=>{
						ServiceTips({text:error.message,type:'error'});
    ...
    chuanghandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/ship/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
		        		this.initChuang();
		        	},(error)=>{
						ServiceTips({text:error.message,type:'error'});
    ...
    yunshuhandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/lsreqir/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
		        		this.initYunshu();
		        	},(error)=>{
						ServiceTips({text:error.message,type:'error'});
    ...
    zhuangChuanghandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/require/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
    ...
    heYanhandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/test/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
		        		this.initheYan();
		        	},(error)=>{
						ServiceTips({text:error.message,type:'error'});
    ...
    zhuangXianghandleClick(e, data, Template){
    	...
    	if(data.number ==2){
        	 Confirm(i18n.t(100433/*删除后将无法恢复，您确定删除吗？*/), {
				   ...
				   apiForm(API_FOODING_ERP,'/saleoffer/pakg/delete',{id:select.billDtlId},(response)=>{
		        		ServiceTips({text:response.message,type:'sucess'});
