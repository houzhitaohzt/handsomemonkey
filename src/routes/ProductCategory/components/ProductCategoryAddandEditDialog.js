...
class CommonFormCategory extends Component{
	constructor(props){
		super(props)
		...
		let dom = (<div className={'girdlayout'} style={{height:"225px"}}>
					<div className={'row'}>
						<div className="form-group col-xs-12 col-md-12">
							<label className={'col-xs-1 col-md-1'}><span>*</span>{i18n.t(100000/*代码*/)}</label>
					...
					<div className={'row'}>
						<div className="form-group col-xs-12 col-md-12">
							<label className={'col-xs-1 col-md-1'}><span>*</span>{i18n.t(100001/*名称*/)}</label>
...
CommonFormCategory = createForm()(CommonFormCategory);

export default CommonFormCategory;
