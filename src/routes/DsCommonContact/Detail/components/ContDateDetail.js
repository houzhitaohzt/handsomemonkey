...
export  class  contDateDetail extends Component{
	...
	editClick = () => {
		...
		navReplaceTab({name:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),component:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),url:'/commoncontact/edit'});
		this.props.router.push({pathname:'/commoncontact/edit',query:oldQuery, state: {refresh: true}});
	}
	backClick = () => {
		let {navAddTab,navReplaceTab} = this.props;
		let oldQuery = this.props.location.query;
		navReplaceTab({name:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),component:I18n.t(100439/*编辑*/) + I18n.t(100588/*联络*/),url:'/commoncontact/edit'});
		this.props.router.push({pathname:'/commoncontact/edit',query:oldQuery, state: {refresh: false}});
	}
	//转商机
	onTurnToBusiClick = () => {
		let that = this;
		...
		apiForm(API_FOODING_OA,'/activity/business/update',{id:commonData.id},response => {
			...
			let name = I18n.t(100439/*编辑*/) + I18n.t(100321/*商机*/) + '(' + (valueone.no || valueone.sourceNo) + ")";
