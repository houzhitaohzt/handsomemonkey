...
class ForwarderContact extends Component{
	constructor(props){
		super(props);
	...
	*/
	render(){
		...
		return(<DsContactDate pageIdent='forwarder' type={"forwarder"}
							  contact ={no => this.contact = no}  isDetail ={true}
							  activityType={20} router={this.props.router}
							  salBeId={salBeId} salBeLcName={salBeLcName} salBeEnName = {salBeEnName} typeNumber={90}/>)
	}
}
