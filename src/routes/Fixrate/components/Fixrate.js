...
import Fixrateplug from './Fixrateplug';
...
class FrExRat extends Component{
	...
	getPage(currentPage,objValue){
		...
		let object=Object.assign({},{isPlatform:true, pageSize: this.state.pageSize, currentPage: currentP,exRateTypeId:20},that.normalRef.getForm());
				...
				<div className={'client-body-single'}>
				  <div className="action-buttons">
					...
					<Dialog width={926} visible={this.state.rodalShow} title={this.state.title} showHeader ={this.state.showHeader}>
						<Fixrateplug DialogContent={this.state.DialogContent}
