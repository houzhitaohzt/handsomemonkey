					...
					<div className={'  girdlayout'}>
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}>{I18n.t(100281/*汇率类型*/)}</label>
								 <ConstVirtualSelect form={this.props.form}
									isRequest={false}
									initValueOptions={[i18n.t(200561/*固定汇率*/)].map(da => ({id:20, name: da}))}
							...
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}>{I18n.t(100282/*汇率精度*/)}</label>
						...
						<div className={'row'}>
								<div className="form-group col-md-6 col-lg-6">
									<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(100283/*原币*/)}</label>
									<ConstMiniSelect form={this.props.form}
								...
								<div className="form-group col-md-6 col-lg-6">
									<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(100285/*目标币*/)}</label>
									<ConstMiniSelect form={this.props.form}
						             				 pbj='com.fooding.fc.ds.entity.Curren' 
						...
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}>{I18n.t(100279/*直接汇率*/)}</label>
							...
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}>{I18n.t(100280/*间接汇率*/)}</label>
								<input type="text" className='col-xs-8 col-md-8 text-input-nowidth'
						...
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}>{I18n.t(100292/*使用企业*/)}</label>
								<Select
											animation='slide-up'
			   ...
			   content = (
			   	<div className={'addnormal'} style={{marginBottom:'10px'}}>
					<div className={'  girdlayout'}>
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(100281/*汇率类型*/)}</label>
								<ConstVirtualSelect form={this.props.form}
									isRequest={false}
									initValueOptions={[i18n.t(200561/*固定汇率*/)].map(da => ({id:20, name: da}))}
                                    initialValue={checkedData.exRateType ? {
					                        exRateTypeId: checkedData.exRateType.id,
					                       s_label: checkedData.exRateType.name
					                } : undefined}
                                     fieldName="exRateTypeId"
                                      rules
                                      className ={'col-md-8 col-lg-8 currency-btn select-from-currency'}
							...
							<div className="form-group col-md-6 col-lg-6">
								<label className={'col-md-4 col-lg-4'}><span>*</span>{I18n.t(100282/*汇率精度*/)}</label>
								<ConstMiniSelect form={this.props.form}
				             				 pbj='com.fooding.fc.enumeration.ExRatePrecision' 
                                             fieldName="exRatePrecisionId"
                                             optionValue={da => <Option key={da.id} objValue={{
						...
						<div className={'row'}>
							<div className="form-group col-md-6 col-lg-6">
								...
								<input type="text" className='col-xs-8 col-md-8 text-input-nowidth'
										{...getFieldProps('basRat',{
													initialValue:checkedData.basRat?checkedData.basRat:''
										})}
								/> 
							</div>
							<div className="form-group col-md-6 col-lg-6">
								...
								<input type="text" className='col-xs-8 col-md-8 text-input-nowidth'
										{...getFieldProps('indirectRat',{
													initialValue:checkedData.indirectRat?checkedData.indirectRat:''
										})}
								/> 
							</div>
						</div>
