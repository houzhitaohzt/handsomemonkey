...
class CommonForm extends Component {
    ...
    onAttrChange = data => {
        ...
        if(data.attrClass === 'com.fooding.fc.es.entity.Staff'){
            apiGet(API_FOODING_ES, '/staff/getListByCcId', {ccid: WebData.user.data.staff.ccid},
            // apiGet(API_FOODING_ES, '/user/getListForPermissionsInParty', {partyId: this.props.partyId},
                (response) => {
                    ...
                    let data = response.data.map(da => ({id: da.id, name: da.localName}));
