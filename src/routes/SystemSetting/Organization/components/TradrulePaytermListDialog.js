...
import {apiGet, apiPost, apiForm, API_FOODING_ES, API_FOODING_DS, language} from "../../../../services/apiCall";
                    ...
                    <div className={'row'}>
                        ...
                        <div className="form-group col-xs-6 col-md-6">
                            ...
                            <ConstVirtualSelect
                                ...
                                apiType={apiPost}
                                rules
                                initValueOptions={tradrulePayterm && tradrulePayterm.payTrm ? [tradrulePayterm.payTrm] : []}
