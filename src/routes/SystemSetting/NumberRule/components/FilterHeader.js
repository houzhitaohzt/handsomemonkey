...
class SystemStaffFilterHeader extends Component {
    ...
    // search 
    searchHandle = ()=> this.props.searchHandle(this.props.form.getFieldsValue());

    // reset
    cleanForm = () => {
        this.props.form.resetFields(); // 清除表单
		this.props.searchHandle({});	// 刷新 列表
    };
                ...
                <div className={'filter-header'}>
                    ...
                    <div className={'filter-header-information-pre'}>
                        ...
                        <input type="text" className={'text-input-filter-header'} placeholder=""
                               {...getFieldProps('description', {initialValue:''})}
                        />
                    </div>
                    <div className={'filter-header-key'}>
                        <span className="search" onClick={this.searchHandle}><i className="foddingicon fooding-search_icon"></i></span>
