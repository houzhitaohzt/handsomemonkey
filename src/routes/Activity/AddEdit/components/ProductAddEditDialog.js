...
class ProductAddEditDialog extends Component{
	...
	productSelect(item){
		let that = this;
		apiGet(API_FOODING_DS,'/material/getProductInforErp',{sourceId:this.props.otherData.salBeId,id:item.id,mtlType:'mtl'},(response)=>{
					  	...
					  	<div className={'row'}>
			                <div className="form-group col-xs-12 col-md-12">
								...
								<ProductSelect 
									...
									titleClass={"col-md-11 col-lg-11"}
									value={initData["mtl"+language]?{s_label:initData["mtl"+language],mtlId:initData.mtlId,mtlLcName:initData.mtlLcName,mtlEnName:initData.mtlEnName}:undefined}
									onSelect = {this.productSelect}
									url='/beMtl/getMtlList'
									isSearch = {false}
									params={{keyword:"",sourceId:that.props.otherData.salBeId}}
								/>
							</div>
						</div>
						<div className={'row'}>
