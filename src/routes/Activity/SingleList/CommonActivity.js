...
class CommonActivity extends Component {
    ...
    static defaultProps = {
        ...
        salBeName: "",
        salBeLcName: '',
        typeNumber: 10, //判断哪一个进入的编辑页面 默认为客户
    ...
    addClick = () => {
        ...
        navRemoveTab({
            name: I18n.t(100439/*编辑*/) + I18n.t(100585/*市场活动响应*/),
            component: I18n.t(100439/*编辑*/) + I18n.t(100585/*市场活动响应*/),
            url: '/activity/edit'
        });
        navAddTab({
            name: I18n.t(100392/*新增*/) + I18n.t(100585/*市场活动响应*/),
            component: I18n.t(100392/*新增*/) + I18n.t(100585/*市场活动响应*/),
            url: '/activity/edit'
        });
        that.props.router.push({
            ...
            query: {
                ...
                salBeLC: encodeURIComponent(this.props.salBeLcName),
                salBeEN: encodeURIComponent(this.props.salBeEnName),
                typeNumber: this.props.typeNumber,
                isDt: this.props.isDt
            }
        });
    }
    onRowDoubleClick = (record, index, checked) => {
        ...
        navRemoveTab({
            ...
            component: I18n.t(100585/*市场活动响应*/) + I18n.t(100097/*详情*/),
            url: '/activity/detail'
        });
        navAddTab({
            name: I18n.t(100585/*市场活动响应*/) + I18n.t(100097/*详情*/),
    ...
    deleteClick = () => {
        let that = this;
        let num = that.refs['commonActivity' + this.props.type].getSelectArr();
        let tempString = "", id = [];
        if (!num.length) {
    ...
    getPages = (currentPage, size, filter, order, props = this.props) => {
        ...
        let params = Object.assign({}, {
            currentPage: currentPage, pageSize: size, activityType: props.activityType,
    ...
    componentWillReceiveProps(nextProps) {
        this.handleResize(0);
        window.addEventListener('resize', this.handleResize(0));
        if (!this.props.isDetail && this.props.activityType !== nextProps.activityType || this.props.salBeId !== nextProps.salBeId || this.props.typeNumber !== nextProps.typeNumber) {
    ...
    render() {
        ...
        switch (pageIdent) {
            case 'client' :	 // 客户
                var iconArray = [{type: 'add', onClick: this.addClick, permissions: 'clien.dtl.add'}, {
                    type: 'delete',
                    onClick: this.deleteClick,
                    permissions: 'clien.dtl.del'
                }];
                break;
            case 'clientLinkman' :	 // 客户联系人
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'clientcontact.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'clientcontact.dtl.del'}];
                break;
            case 'provider' :	 // 供应商
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'provider.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'provider.dtl.del'}];
                break;
            case 'providerLinkman' :	 // 供应商联系人
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'providercontact.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'providercontact.dtl.del'}];
                break;
            case 'forwarder' :  // 货代公司
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'forwarder.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'forwarder.dtl.del'}];
                break;
            case 'forwarderLinkman' :  // 货代公司联系人
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'forwardercontact.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'forwardercontact.dtl.del'}];
                break;
            case 'serverLinkman' :  // 服务机构联系人
                var iconArray = [{
                    type: 'add',
                    onClick: this.addClick,
                    permissions: 'servbecontact.dtl.add'
                }, {type: 'delete', onClick: this.deleteClick, permissions: 'servbecontact.dtl.del'}];
                break;
            default:
            ...
            <div className="contact-fluid">
                ...
                <div className="contact-body" style={{height: this.state.scrollHeight}}>
                    ...
                    <div className="action-contact-buttons">
                        <Table
                            ref={'commonActivity' + this.props.type}
...
export default NavConnect(CommonActivity);
